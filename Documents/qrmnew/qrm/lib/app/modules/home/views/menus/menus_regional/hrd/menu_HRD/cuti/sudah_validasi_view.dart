...
import 'package:qrm/app/modules/home/views/menus/menus_regional/hrd/menu_HRD/cuti/cuti_hrd_detail_view.dart';
      ...
      return LzListView(
        ...
        children: [
          ...
          ...data.generate((item, i) {
            return Touch(
              onTap: () {
                Get.to(() => CutiHrdDetailView(data: item))?.then((value) {
                  if (value != null) {
                    controller.updateData(HrdCuti.fromJson(value), item.id!);
                  }
                });
              },
              margin: Ei.only(b: 10),
