...
class PengajuanAll {
  ...
  factory PengajuanAll.fromJson(Map<String, dynamic> json) => PengajuanAll(
        id: json['id'] as int?,
  ...
  static List<PengajuanAll> fromJsonList(List? data) {
    return (data ?? []).map((e) => PengajuanAll.fromJson(e)).toList();
  }
}
