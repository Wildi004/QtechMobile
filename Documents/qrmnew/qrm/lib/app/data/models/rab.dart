class Rab {
  ...
  factory Rab.fromJson(Map<String, dynamic> json) => Rab(
        id: json['id'] as int?,
  ...
  static List<Rab> fromJsonList(List<dynamic> list) {
    return list.map((e) => Rab.fromJson(e as Map<String, dynamic>)).toList();
  }
}
