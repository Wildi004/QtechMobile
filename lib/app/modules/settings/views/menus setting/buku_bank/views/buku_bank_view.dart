...
import 'package:qrm_dev/app/modules/settings/views/menus%20setting/buku_bank/controllers/buku_bank_controller.dart';
...
class BukuBankView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppbar(title: 'Buku Bank'),
      body: Column(
        children: [
                              ...
                              return Padding(
                                ...
                                child: LzCard(
                                  children: [
                                    ...
                                    Text(
                                      'Debit : ${item.debit ?? 'tidak ada'}',
                                      style: CustomTextStyle.subtitle(),
                                    ),
                                    Text(
                                      'Kredit : ${item.kredit ?? 'tidak ada'}',
                                      style: CustomTextStyle.subtitle(),
                                    ),
                                  ],
                                ),
