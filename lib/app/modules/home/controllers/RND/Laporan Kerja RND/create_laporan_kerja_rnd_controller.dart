...
class CreateLaporanKerjaRndController extends GetxController with Apis {
  ...
  Future<List<Map<String, dynamic>>> getCategoryOptions() async {
    try {
      if (categories.isEmpty) {
        final res = await api.rk.getLaporanRnd(query).ui.loading();
  ...
  Future<void> onSubmit() async {
    try {
      ...
      final res =
          await api.rk.createDataRnd(payload).ui.loading('Menyimpan...');
