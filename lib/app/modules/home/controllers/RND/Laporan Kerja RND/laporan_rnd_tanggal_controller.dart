...
class LaporanRndTanggalController extends GetxController with Apis {
  ...
  Future loadRkPic(String encryptedTglRencana, String encryptedPic) async {
    ...
    try {
      ...
      final res = await api.rk.getTanggalRnd(encryptedTglRencana, encryptedPic);
  ...
  Future sendToTelegram(String encryptedTglRencana, String encryptedPic) async {
    try {
      ...
      final res =
          await api.rk.sendToTelegramRnd(encryptedTglRencana, encryptedPic);
