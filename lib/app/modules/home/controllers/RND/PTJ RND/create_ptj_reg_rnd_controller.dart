...
class CreatePtjRegRndController extends GetxController with Apis {
  DetailPtjIt? created;
  ...
  CreatePtjRegRndController(this.type);
  final String type;
  ...
  Future<void> getPengajuanDetails() async {
    if (dataPengajuanDetails.isEmpty) {
      final res = await api.pengajuanGlobal.getDataRndDetail().ui.loading();
