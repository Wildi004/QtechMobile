...
class ArsipSuratMasukRndController extends GetxController with Apis {
  ...
  Future getBrosur() async {
    try {
      ...
      final res = await api.arsipSuratMasukBsd.getDataRnd(query);
  ...
  Future updateSearchQuery(String value) async {
    try {
      ...
      isLoading.value = true;
      final res =
          await api.arsipSuratMasukBsd.getDataRnd({...query, 'search': value});
      total = res.body?['pagination']?['total_records'] ?? 0;
