...
class EditPengajuanItController extends GetxController with Apis {
  PengajuanIt? data;
  ...
  Future getItems() async {
    final res = await api.rabGlobal.getDataIt();
  ...
  Future<void> getRab(String value, int index) async {
    if (value == 'RAB' && dataRabDetails.isEmpty) {
      final res = await api.rabGlobal.getDataRabItDetail().ui.loading();
      dataRabDetails = RabDetailValidasi.fromJsonList(res.data);
    }
