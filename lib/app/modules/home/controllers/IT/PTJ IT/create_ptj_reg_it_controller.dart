...
class CreatePtjRegItController extends GetxController with Apis {
  DetailPtjIt? created;
  ...
  CreatePtjRegItController(this.type);
  final String type;
  ...
  Future<void> getPengajuanDetails() async {
    if (dataPengajuanDetails.isEmpty) {
      final res = await api.pengajuanGlobal.getDataItDetail().ui.loading();
