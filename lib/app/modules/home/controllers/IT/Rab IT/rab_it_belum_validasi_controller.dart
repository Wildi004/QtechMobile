...
class RabItBelumValidasiController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.rabGlobal.getDataBelumValidasiIt(query);
  ...
  Future updateSearchQuery(String value) async {
    try {
      ...
      final res = await api.rabGlobal
          .getDataBelumValidasiIt({...query, 'search': value});
      total = res.body?['pagination']?['total_records'] ?? 0;
  ...
  Future onPaginate() async {
    try {
      ...
      final res = await api.rabGlobal
          .getDataBelumValidasiIt({...query, 'search': searchC.text});
