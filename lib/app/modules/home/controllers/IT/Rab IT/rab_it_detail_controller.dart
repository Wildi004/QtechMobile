...
class RabItDetailController extends GetxController with Apis {
  RabIt? data;
  ...
  //   try {
  //     int? id = data.id;
  //     final res = await api.rabGlobal.getDataRabItById(id!);
  ...
  //       logg('total_harga: $totalHargaVal (${totalHargaVal.runtimeType})');
  ...
  Future getDetails(RabIt data) async {
    try {
      ...
      final res = await api.rabGlobal.getDataRabItById(data.id!);
      details = RabIt.fromJson(res.data ?? {});
      cards.value = details.rabDetail ?? [];
