...
class ArsipSuratKeluarItController extends GetxController with Apis {
  ...
  Future getBrosur() async {
    try {
      ...
      final res = await api.arsipSuratKeluarBsd.getDataIt(query);
  ...
  Future updateSearchQuery(String value) async {
    try {
      ...
      isLoading.value = true;
      final res =
          await api.arsipSuratKeluarBsd.getDataIt({...query, 'search': value});
      total = res.body?['pagination']?['total_records'] ?? 0;
