...
class DelPembJktNonPpnController extends GetxController with Apis {
  DelPembNonPpn? data;
  ...
  Future getData() async {
    try {
      ...
      final res = await api.delPembNonPpn.getDataJkt(query);
  ...
  void insertData(DelPembNonPpn data) {
    try {
      final controller = Get.find<DelPembJktNonPpnBelumValController>();
