...
class SuratJalanInternalJktBelumValController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.suratJalanInternal.getBelumValJkt(query);
  ...
  void updateData(SuratJalanInternal data, String id) {
    try {
      final controller = Get.find<SuratJalanInternalJktBelumValController>();
