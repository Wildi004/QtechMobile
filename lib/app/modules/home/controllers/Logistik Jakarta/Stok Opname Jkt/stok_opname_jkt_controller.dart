...
class StokOpnameJktController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.stokOpname.getDataJkt(query);
  ...
  Future getDetail(int id) async {
    try {
      ...
      final res = await api.stokOpname.getDataDetailJkt(id);
      final body = res.body;
  ...
  void updateData(StokOpname data, int id) {
    try {
      final controller = Get.find<StokOpnameJktController>();
  ...
  Future deleteData(int id) async {
    try {
      final res =
          await api.stokOpname.deleteDataJkt(id).ui.loading('Menghapus...');
      if (!res.status) {
