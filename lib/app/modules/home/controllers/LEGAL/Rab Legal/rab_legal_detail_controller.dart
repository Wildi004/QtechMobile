...
class RabLegalDetailController extends GetxController with Apis {
  RabLegal? data;
  ...
  Future getDetails(RabLegal data) async {
    try {
      ...
      final res = await api.rabGlobal.getLegalId(data.id!);
      ...
      final Map<int, List<RabDetailLegal>> grouped = {};
