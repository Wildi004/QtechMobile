...
class LaporanKerjaLegalTanggalController extends GetxController with Apis {
  ...
  Future loadRkPic(String encryptedTglRencana, String encryptedPic) async {
    ...
    try {
      ...
      final res =
          await api.rk.getTanggalLegal(encryptedTglRencana, encryptedPic);
  ...
  Future sendToTelegram(String encryptedTglRencana, String encryptedPic) async {
    try {
      ...
      final res =
          await api.rk.sendToTelegramLegal(encryptedTglRencana, encryptedPic);
