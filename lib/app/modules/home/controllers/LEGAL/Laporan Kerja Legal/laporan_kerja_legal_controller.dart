...
class LaporanKerjaLegalController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.rk.getDataLegal(query);
  ...
  Future loadDetail(String encryptedMinggu) async {
    try {
      isLoading.value = true;
      final res = await api.rk.getMingguLegal(encryptedMinggu);
