...
class RbpHasilPerhitunganController extends GetxController with Apis {
...
// material utama
  ...
  Future getData() async {
    try {
      ...
      final res = await api.rbpRb.getData(query);
  ...
  void updateSearchQuery(String query) {
    ...
    datas.value = listData.where((datas) {
      final kodeProyek = datas.kodeProyek?.toLowerCase() ?? '';
      final kodeRbp = datas.kodeRbp?.toLowerCase() ?? '';
      return kodeProyek.contains(searchQuery.value) ||
          kodeRbp.contains(searchQuery.value);
    }).toList();
  }
