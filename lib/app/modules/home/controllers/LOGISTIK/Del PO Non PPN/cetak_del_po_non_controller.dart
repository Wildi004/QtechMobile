...
class CetakDelPoNonController extends GetxController with Apis {
  RxInt tab = 0.obs;
  ...
  Future<void> fetchDeliveries() async {
    try {
      ...
      final res = await api.delPoNonPpn.getDataFilter(query);
      final body = res.body ?? {};
      ...
      if (body['status'] == true && body['data'] != null) {
        ...
        deliveryData.clear();
        Toast.warning('Tidak ada data Delivery PO Non PPN yang ditemukan');
      }
    } catch (e, s) {
      Errors.check(e, s);
    }
