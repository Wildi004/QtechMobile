...
class StokMaterialLogistikController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.stokMaterial.getData(query);
  ...
  Future deleteData(int id) async {
    try {
      final res =
          await api.stokMaterial.deleteData(id).ui.loading('Menghapus...');
      if (!res.status) {
