...
class EditPengajuanLogistikController extends GetxController with Apis {
  ...
  Future<void> getRab(String value, int index) async {
    if (value == 'RAB' && dataRabDetails.isEmpty) {
      final res = await api.rabGlobal.getRabDetailLogistik().ui.loading();
      dataRabDetails = RabDetaillogistik.fromJsonList(res.data);
    }
    ...
    if (value == 'RAB') {
      // 🔹 Resets data manual sebelumnya supaya tidak nyangkut
