...
class LaporanKerjaLogistikController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.rk.getDataLogistik(query);
  ...
  Future loadDetail(String encryptedMinggu) async {
    try {
      isLoading.value = true;
      final res = await api.rk.getMingguLogistik(encryptedMinggu);
