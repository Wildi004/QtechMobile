...
class ServiceAsetLogistikController extends GetxController with Apis {
  ...
  Future getData() async {
    try {
      ...
      final res = await api.serviceAset.getData(query);
  ...
  void updateData(ServiceAset data, int id) {
    try {
      final controller = Get.find<ServiceAsetLogistikController>();
  ...
  Future deleteData(int id) async {
    try {
      final res =
          await api.serviceAset.deleteData(id).ui.loading('Menghapus...');
      if (!res.status) {
