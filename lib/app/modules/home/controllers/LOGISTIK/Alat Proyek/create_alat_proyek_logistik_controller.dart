...
class CreateAlatProyekLogistikController extends GetxController with Apis {
...
// Future getBarang(dynamic id) async {
//   try {
//     // cari stok berdasarkan id yang dipilih
...
//     // isi field nama_barang pakai nama_material_name
//     forms.set('nama_barang', Option(data['nama_material_name'] ?? '')).enable();
