...
class CreateLaporanKerjaHrdController extends GetxController with Apis {
  ...
  Future<List<Map<String, dynamic>>> getCategoryOptions() async {
    try {
      ...
      if (auth.deptId == 23) {
        ...
        query = {'auto': 1};
        logg('${auth.deptId}  $query');
      }

      final res = await api.rk.getLaporanIt(query).ui.loading();
  ...
  Future<void> onSubmit() async {
    try {
      ...
      final res = await api.rk.createData(payload).ui.loading('Menyimpan...');
