...
class HrdNamaPekerjaanPicController extends GetxController with Apis {
  ...
  Future loadRkPic(String encryptedTglRencana, String encryptedPic) async {
    ...
    try {
      ...
      final res = await api.rk.getRkPic(encryptedTglRencana, encryptedPic);
  ...
  Future sendToTelegram(String encryptedTglRencana, String encryptedPic) async {
    try {
      ...
      final res =
          await api.rk.sendToTelegram(encryptedTglRencana, encryptedPic);

      // Cek responsenya, asumsi ada pesan dari server
      Get.back();
