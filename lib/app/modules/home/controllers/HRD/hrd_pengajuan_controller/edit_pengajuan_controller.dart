...
class EditPengajuanController extends GetxController with Apis {
  ...
  void setData(PengajuanSudahValidasi newData) {
    data = newData;
  ...
  Future<void> onSubmit() async {
    try {
      ...
      if (res.status) {
        logg('Hasil res.data setelah submit: ${res.data}', limit: 9999);
