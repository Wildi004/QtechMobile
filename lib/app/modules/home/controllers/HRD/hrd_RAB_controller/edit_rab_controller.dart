...
class EditRabController extends GetxController with Apis {
  RabValidasi? data;
  ...
  Future<void> onSubmit() async {
    try {
      ...
      final res = await api.rabGlobal
          .updateDataRabHrd(payload, data!.id!)
          .ui
          .loading('Memproses...');
