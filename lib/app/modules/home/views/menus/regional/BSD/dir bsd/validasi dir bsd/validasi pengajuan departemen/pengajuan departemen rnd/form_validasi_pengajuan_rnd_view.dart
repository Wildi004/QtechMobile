...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20pengajuan%20departemen/form_validasi_rnd_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class FormValidasiPengajuanRndView extends GetView<FormValidasiRndController> {
  final PengajuanIt? data;
  const FormValidasiPengajuanRndView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiRndController());
    ...
    return Scaffold(
      appBar: CustomAppbar(
        title: 'Form Validasi Pengajuan RND',
        actions: [
          IconButton(
            onPressed: () {
