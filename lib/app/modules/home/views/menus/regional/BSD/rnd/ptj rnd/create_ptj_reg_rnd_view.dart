...
import 'package:qrm_dev/app/modules/home/controllers/RND/PTJ%20RND/create_ptj_rnd_controller.dart';
...
class CreatePtjRegRndView extends GetView<CreatePtjRndController> {
  final String type;
  const CreatePtjRegRndView({super.key, required this.type});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePtjRndController(type));
