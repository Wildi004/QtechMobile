...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20ptj/validasi%20ptj%20rnd/validasi_ptj_rnd_belum_validasi_view.dart';
...
class ValidasiPtjRndView extends GetView<PtjRndController> {
  const ValidasiPtjRndView({super.key});
          ...
          Expanded(
            child: Obx(() {
              if (controller.tab.value == 0) {
                return ValidasiPtjRndBelumValidasiView();
              } else {
