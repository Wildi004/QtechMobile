...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Invoice%20Delivery%20Pembelian%20Non%20PPN/inv_del_pemb_non_ppn_belum_val_controller.dart';
...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20logistik%20bali/validasi%20inv%20del%20pemb%20non%20ppn/form_validasi_inv_del_pemb_non_ppn_view.dart';
...
class ValidasiInvDelPembNonPpnBelumValView
    extends GetView<InvDelPembNonPpnBelumValController> {
  const ValidasiInvDelPembNonPpnBelumValView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => InvDelPembNonPpnBelumValController());
                                              ...
                                              IconButton(
                                                onPressed: () {
                                                  action.show((value) {
                                                    if (value.index == 0) {
                                                      Get.dialog(
                                                        FormValidasiInvDelPembNonPpnView(
                                                            data: item),
                                                      ).then((value) {
                                                        if (value == true) {
                                                          // pindah tab
                                                          final internal = Get.find<
                                                              InvDelPembNonPpnController>();
                                                          internal.tab.value =
                                                              1;

                                                          final belum = Get.find<
                                                              InvDelPembNonPpnBelumValController>();
                                                          belum.listData
                                                              .removeWhere((e) =>
                                                                  e.noHide ==
                                                                  item.noHide);
