...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20del%20pemb%20ppn/form_validasi_del_pemb_ppn_controller.dart';

class FormValidasiDelPembPpnView
    extends GetView<FormValidasiDelPembPpnController> {
  final DelPembPpn? data;
  const FormValidasiDelPembPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiDelPembPpnController());
    ...
    return AlertDialog(
      ...
      title: const Text(
        'Validasi Delivery Pembelian PPN',
