...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20surat%20jalan%20internal%20bali/form_validasi_sj_in_bali_controller.dart';

class FormValidasiSjInBaliView extends GetView<FormValidasiSjInBaliController> {
  final SuratJalanInternal? data;
  const FormValidasiSjInBaliView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiSjInBaliController());
    ...
    return AlertDialog(
      ...
      title: const Text(
        'Validasi Surat Jalan Internal Bali',
