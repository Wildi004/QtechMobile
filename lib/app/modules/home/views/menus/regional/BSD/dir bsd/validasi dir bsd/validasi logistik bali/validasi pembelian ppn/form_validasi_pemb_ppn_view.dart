...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20pemb%20ppn/form_validasi_pemb_ppn_controller.dart';

class FormValidasiPembPpnView extends GetView<FormValidasiPembPpnController> {
  final PembelianPpn? data;
  const FormValidasiPembPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiPembPpnController());
