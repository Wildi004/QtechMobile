...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20inv%20del%20po%20non%20ppn/form_validasi_inv_del_po_non_ppn_controller.dart';

class FormValidasiInvDelPoNonPpnView
    extends GetView<FormValidasiInvDelPoNonPpnController> {
  final InvDelPoNonPpn? data;
  const FormValidasiInvDelPoNonPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiInvDelPoNonPpnController());
    ...
    return AlertDialog(
      ...
      title: const Text(
        'Validasi Invoice Delivery PO Non PPN',
