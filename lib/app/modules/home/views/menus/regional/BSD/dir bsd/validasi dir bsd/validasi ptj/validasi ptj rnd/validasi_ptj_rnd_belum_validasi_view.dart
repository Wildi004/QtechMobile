...
import 'package:qrm_dev/app/modules/home/controllers/RND/PTJ%20RND/ptj_rnd_belum_validasi_controller.dart';
import 'package:qrm_dev/app/modules/home/controllers/RND/PTJ%20RND/ptj_rnd_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20ptj/validasi%20ptj%20rnd/form_validasi_ptj_rnd_view.dart';
...
class ValidasiPtjRndBelumValidasiView
    extends GetView<PtjRndBelumValidasiController> {
  const ValidasiPtjRndBelumValidasiView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      Get.lazyPut(() => PtjRndBelumValidasiController());
              ...
              children: [
                ...data.generate((item, i) {
                  ...
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => FormValidasiPtjRndView(data: item))
                              ?.then((value) {
                            if (value == true) {
                              final internal = Get.find<PtjRndController>();
                              internal.tab.value = 1;

                              final belum =
                                  Get.find<PtjRndBelumValidasiController>();
                              belum.listPtj
