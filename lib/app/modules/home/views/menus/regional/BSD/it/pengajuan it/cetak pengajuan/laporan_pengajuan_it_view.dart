...
import 'package:qrm_dev/app/modules/home/controllers/IT/Pengajuan%20It/laporan_pengajuan_it_controller.dart';
...
class LaporanPengajuanItView extends GetView<LaporanPengajuanItController> {
  const LaporanPengajuanItView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LaporanPengajuanItController());
