...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20pengajuan%20departemen/pengajuan%20departemen%20logistik/pengajuan_logistik_belum_valid_view.dart';
...
class ValidasiPengajuanLogistikView
    extends GetView<PengajuanLogistikController> {
  const ValidasiPengajuanLogistikView({super.key});
            ...
            Expanded(
              child: Obx(() {
                if (controller.tab.value == 0) {
                  return PengajuanLogistikBelumValidView();
                } else {
