...
import 'package:qrm_dev/app/modules/home/controllers/IT/PTJ%20IT/cetak_ptj_it_controller.dart';
...
class CetakPtjItView extends GetView<CetakPtjItController> {
  const CetakPtjItView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CetakPtjItController());
