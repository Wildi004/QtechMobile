...
class PengajuanDepBsdBelum extends GetView<PengajuanDevBsdBelumController> {
  const PengajuanDepBsdBelum({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      Get.lazyPut(() => PengajuanDevBsdBelumController());
