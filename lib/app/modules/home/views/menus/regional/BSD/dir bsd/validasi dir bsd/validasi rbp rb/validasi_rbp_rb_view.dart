...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20rbp%20rb/validasi_rbp_rb_belum_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20rbp%20rb/validasi_rbp_rb_sudah_view.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class ValidasiRbpRbView extends GetView<ValidasiRbpRbBelumController> {
  const ValidasiRbpRbView({super.key});
            ...
            Expanded(
              child: Obx(() {
                if (controller.tab.value == 0) {
                  return ValidasiRbpRbBelumView();
                } else {
                  return ValidasiRbpRbSudahView();
                }
              }),
            ),
          ],
