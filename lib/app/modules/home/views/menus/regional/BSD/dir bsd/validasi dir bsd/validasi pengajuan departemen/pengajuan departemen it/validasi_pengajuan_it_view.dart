...
class ValidasiPengajuanItView extends GetView<PengajuanItController> {
  const ValidasiPengajuanItView({super.key});
            ...
            Expanded(
              child: Obx(() {
                if (controller.tab.value == 0) {
                  return PengajuanItBelumValidView();
                } else {
