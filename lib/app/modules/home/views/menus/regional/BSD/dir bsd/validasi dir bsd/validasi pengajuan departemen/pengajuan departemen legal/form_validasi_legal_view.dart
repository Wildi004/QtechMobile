...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20pengajuan%20departemen/form_validasi_legal_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class FormValidasiLegalView extends GetView<FormValidasiLegalController> {
  final PengajuanLegal? data;
  const FormValidasiLegalView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiLegalController());
    ...
    return Scaffold(
      appBar: CustomAppbar(
        title: 'Form Validasi Pengajuan Legal',
        actions: [
          IconButton(
            onPressed: () {
