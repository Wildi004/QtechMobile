...
class ValidasiPengajuanHrdView extends GetView<PengajuanHrdController> {
  const ValidasiPengajuanHrdView({super.key});
            ...
            Expanded(
              child: Obx(() {
                if (controller.tab.value == 0) {
                  return PengajuanHrdBelumValidVeiw();
                } else {
