...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20pengajuan%20departemen/form_validasi_hrd_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class FormValidasiHrdView extends GetView<FormValidasiHrdController> {
  final PengajuanSudahValidasi? data;
  const FormValidasiHrdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiHrdController());
    ...
    return Scaffold(
      appBar: CustomAppbar(
        title: 'Form Validasi Pengajuan HRD',
        actions: [
          IconButton(
            onPressed: () {
