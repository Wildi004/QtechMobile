...
class CreatePtjRndView extends GetView<CreatePtjRndController> {
  final String type;
  const CreatePtjRndView({super.key, required this.type});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  LzForm.input(
                      label: 'Type', enabled: false, model: forms.key('type')),
                ],
              ),
            ),
            Expanded(
