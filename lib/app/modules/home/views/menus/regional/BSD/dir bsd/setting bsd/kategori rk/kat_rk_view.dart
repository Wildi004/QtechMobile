...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Setting%20Bsd/Kategori%20Rk/kat_rk_controller.dart';
...
class KatRkView extends GetView<KatRkController> {
  const KatRkView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => KatRkController());
      ...
      child: Scaffold(
        appBar: CustomAppbar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                // Get.to(() => CreateKatRkView())?.then((data) {
                //   if (data != null) {
