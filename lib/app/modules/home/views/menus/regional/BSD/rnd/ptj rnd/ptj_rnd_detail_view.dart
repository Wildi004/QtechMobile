...
import 'package:qrm_dev/app/modules/home/controllers/RND/PTJ%20RND/ptj_rnd_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class PtjRndDetailView extends GetView<PtjRndDetailController> {
  final PtjIt? data;
  const PtjRndDetailView({super.key, this.data});
  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => PtjRndDetailController()..data = data);
