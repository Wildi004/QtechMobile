...
import 'package:qrm_dev/app/modules/home/controllers/RND/Rab%20RND/edit_rab_rnd_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditRabRndView extends GetView<EditRabRndController> {
  final RabIt? data;

  const EditRabRndView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.put(EditRabRndController()..data = data);
