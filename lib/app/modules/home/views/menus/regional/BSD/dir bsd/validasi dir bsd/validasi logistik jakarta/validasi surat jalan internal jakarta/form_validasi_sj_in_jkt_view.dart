...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20jakarta/validasi%20surat%20jalan%20internal%20jakarta/form_validasi_sj_in_jkt_controller.dart';

class FormValidasiSjInJktView extends GetView<FormValidasiSjInJktController> {
  final SuratJalanInternal? data;
  const FormValidasiSjInJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiSjInJktController());
    ...
    return AlertDialog(
      ...
      title: const Text(
        'Validasi Surat Jalan Internal Jakarta',
