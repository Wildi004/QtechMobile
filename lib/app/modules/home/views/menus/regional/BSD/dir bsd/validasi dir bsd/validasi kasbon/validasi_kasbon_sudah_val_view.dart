...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20kasbon/validasi_kasbon_detail_view.dart';
import 'package:qrm_dev/app/widgets/custom_decoration.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_scala_container.dart';
import 'package:qrm_dev/app/widgets/custom_search_query.dart';

class ValidasiKasbonSudahValView extends GetView<ValidasiKasbonController> {
  const ValidasiKasbonSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => ValidasiKasbonDetailView(data: item));
                        },
                        margin: Ei.only(b: 10),
                        child: Container(
                          width: itemWidth,
