...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20logistik%20bali/validasi%20del%20pemb%20non%20ppn/form_validasi_del_pemb_non_ppn_view.dart';
...
class ValidasiDelPembNonPpnBelumValView
    extends GetView<DelPembNonPpnBelumValController> {
  const ValidasiDelPembNonPpnBelumValView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => DelPembNonPpnBelumValController());
                                              ...
                                              IconButton(
                                                onPressed: () {
                                                  action.show((value) {
                                                    if (value.index == 0) {
                                                      Get.dialog(
                                                        FormValidasiDelPembNonPpnView(
                                                            data: item),
                                                      ).then((value) {
                                                        if (value == true) {
                                                          final internal = Get.find<
                                                              DelPembNonPpnController>();
                                                          internal.tab.value =
                                                              1;
