...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/it/ptj%20it/ptj_it_detail_view.dart';
...
class ValidasiPtjItSudahValView
    extends GetView<ValidasiPtjItSudahValController> {
  const ValidasiPtjItSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  ...
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => PtjItDetailView(data: item))
                              ?.then((value) {
                            if (value != null) {
