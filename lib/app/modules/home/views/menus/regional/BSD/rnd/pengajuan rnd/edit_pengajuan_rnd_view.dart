...
import 'package:qrm_dev/app/modules/home/controllers/RND/Pengajuan%20RND/edit_pengajuan_rnd_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditPengajuanRndView extends GetView<EditPengajuanRndController> {
  final PengajuanIt? data;

  const EditPengajuanRndView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditPengajuanRndController());
