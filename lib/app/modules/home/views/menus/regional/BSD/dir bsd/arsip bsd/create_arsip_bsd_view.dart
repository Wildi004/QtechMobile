...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Arsip%20Dir%20Bsd/create_arsip_bsd_controller.dart';

class CreateArsipBsdView extends GetView<CreateArsipBsdController> {
  final ArsipDirBsd? data;

  const CreateArsipBsdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateArsipBsdController());
