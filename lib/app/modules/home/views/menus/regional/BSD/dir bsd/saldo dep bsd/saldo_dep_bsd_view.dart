...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/saldo%20dep%20bsd/debit_dep_bsd_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/saldo%20dep%20bsd/kredit_dep_bsd_view.dart';
...
class SaldoDepBsdView extends GetView<SaldoDepBsdController> {
  const SaldoDepBsdView({super.key});
          ...
          IconButton(
            onPressed: () {
              ...
              Get.to(() => SaldoDistribusiView())?.then((data) {
                if (data != null) {
                  controller.insertData(SaldoDepBsd.fromJson(data));
                }
              });
            },
            icon: Icon(Hi.add01),
          ...
          Expanded(
            child: Obx(() {
              if (controller.tab.value == 0) {
                return DebitDepBsdView();
              } else {
                return KreditDepBsdView();
              }
            }),
          ),
          Obx(() {
