...
class ValRbpRjMaterialUtamaView extends GetView<ValidasiRbpRjSudahController> {
  final String? noHide;

  final RbpRbNohide? data;

  const ValRbpRjMaterialUtamaView({super.key, this.data, this.noHide});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final items = controller.detailDatas.first.materialUtama ?? [];
            ...
            return Padding(
              ...
              child: LzCard(
                children: [
                  ...
                  const Divider(),
                  _buildBoldText('Uraian', item.uraianMu),
                  _buildBoldText('Jumlah', item.jumlahMu),
                  _buildBoldText('Satuan', item.satuan),
                  _buildBoldText('Harga Satuan', item.hargaModal),
                  _buildBoldText('Total Harga', item.totalHargaMu),
                ],
              ),
            );
          }),
