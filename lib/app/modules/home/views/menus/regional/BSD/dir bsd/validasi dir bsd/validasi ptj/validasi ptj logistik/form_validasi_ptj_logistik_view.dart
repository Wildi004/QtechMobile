...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/Validasi%20PTJ/validasi%20ptj%20logistik/form_validasi_ptj_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class FormValidasiPtjLogistikView
    extends GetView<FormValidasiPtjLogistikController> {
  final PtjLogistik? data;
  const FormValidasiPtjLogistikView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiPtjLogistikController());
    ...
    return Scaffold(
      appBar: CustomAppbar(
        title: 'Form Validasi PTJ Logistik',
        actions: [
          IconButton(
            onPressed: () {
