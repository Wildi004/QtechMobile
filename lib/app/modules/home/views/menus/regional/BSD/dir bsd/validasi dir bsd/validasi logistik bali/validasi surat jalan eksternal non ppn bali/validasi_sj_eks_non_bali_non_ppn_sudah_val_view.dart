...
class ValidasiSjEksNonBaliNonPpnSudahValView
    extends GetView<SuratJalanExstNonController> {
  const ValidasiSjEksNonBaliNonPpnSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => SuratJalanExstNonDetailView(data: item))
                              ?.then((value) {
