...
class PtjItBelumValidasiView extends GetView<PtjItBelumValidasiController> {
  const PtjItBelumValidasiView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      Get.lazyPut(() => PtjItBelumValidasiController());
