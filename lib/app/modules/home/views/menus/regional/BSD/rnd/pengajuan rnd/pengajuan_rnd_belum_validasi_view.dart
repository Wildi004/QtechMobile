...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/rnd/pengajuan%20rnd/edit_pengajuan_rnd_view.dart';
...
class PengajuanRndBelumValidasiView
    extends GetView<PengajuanRndBelumController> {
  const PengajuanRndBelumValidasiView({super.key});
                ...
                ...data.generate((item, i) {
                  ...
                  return ListItemAnimasi(
                    ...
                    child: CustomScalaContainer(
                      child: Touch(
                          onTap: () {
                            Get.to(() => PengajuanRndDetailView(data: item))
                                ?.then((value) {
                                ...
                                Row(
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () {
                                        Get.to(() => EditPengajuanRndView(
                                            data: item))?.then((value) {
                                          if (value != null) {
                                            final form = Get.find<
                                                PengajuanRndBelumController>();
                                            form.updateData(
