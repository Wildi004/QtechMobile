...
class LaporanRndTanggalView extends GetView<LaporanRndTanggalController> {
  final String encryptedTglRencana;
  final String encryptedPic;

  const LaporanRndTanggalView({
    super.key,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style:
                                          const TextStyle(fontWeight: Fw.bold),
                                    ),
