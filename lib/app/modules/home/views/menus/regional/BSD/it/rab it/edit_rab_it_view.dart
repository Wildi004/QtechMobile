...
import 'package:qrm_dev/app/modules/home/controllers/IT/Rab%20IT/edit_rab_it_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditRabItView extends GetView<EditRabItController> {
  final RabIt? data;

  const EditRabItView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.put(EditRabItController()..data = data);
