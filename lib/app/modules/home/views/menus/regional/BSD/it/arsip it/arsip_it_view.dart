...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/it/arsip%20it/detail_arsip_it_view.dart';
...
class ArsipItView extends GetView<ArsipItController> {
  const ArsipItView({super.key});
                ...
                ...data.generate((item, i) {
                  return ListItemAnimasi(
                    ...
                    child: CustomScalaContainer(
                      child: Touch(
                        onTap: () {
                          Get.to(() => DetailArsipItView(data: item))
                              ?.then((value) {});
                        },
                        margin: Ei.only(b: 10),
                        child: Container(
