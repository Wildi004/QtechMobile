...
import 'package:qrm_dev/app/modules/home/controllers/RND/Pengajuan%20RND/laporan_pengajuan_rnd_controller.dart';
...
class LaporanPengajuanRndView extends GetView<LaporanPengajuanRndController> {
  const LaporanPengajuanRndView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(LaporanPengajuanRndController());
                ...
                children: [
                  ...
                  if (controller.deliveryData.isNotEmpty) ...[
                    ...
                    ...controller.deliveryData.asMap().entries.map((entry) {
                      ...
                      final int? status = item['status_acc_dir'];
                      ...
                      return Padding(
                        ...
                        child: LzCard(
                          children: [
                            ...
                            const Divider(),
                            _buildBoldText('Tanggal', item['shipment_date']),
                            _buildBoldText(
                                'No. Pengajuan', item['no_pengajuan']),
                            _buildBoldText('Nama Item', item['nama_barang']),
                            _buildBoldText('Qty', item['qty']),
                            _buildBoldText('Harga (Rp.)', item['harga']),
                            _buildBoldText(
