...
class FormValidasiCutiBsdView extends GetView<FormValidasiCutiBsdController> {
  final ProfileCuti? data;

  const FormValidasiCutiBsdView({super.key, this.data});
              ...
              child: LzListView(
                ...
                children: [
                  ...
                  LzForm.select(
                    ...
                    model: controller.forms.key('status_dir_keuangan'),
                    onTap: () async {
                      final data = await controller.statusV().overlay();
                      controller.forms
                          .set('status_dir_keuangan')
