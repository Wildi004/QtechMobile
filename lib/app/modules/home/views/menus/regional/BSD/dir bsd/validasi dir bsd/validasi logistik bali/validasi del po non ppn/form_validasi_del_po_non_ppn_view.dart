...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20del%20po%20non%20ppn/form_validasi_del_po_non_ppn_controller.dart';

class FormValidasiDelPoNonPpnView
    extends GetView<FormValidasiDelPoNonPpnController> {
  final DelPoNonPpn? data;
  const FormValidasiDelPoNonPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiDelPoNonPpnController());
