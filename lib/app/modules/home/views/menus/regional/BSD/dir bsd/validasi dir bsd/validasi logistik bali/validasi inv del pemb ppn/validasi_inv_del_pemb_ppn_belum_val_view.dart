...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20logistik%20bali/validasi%20inv%20del%20pemb%20ppn/form_validasi_inv_del_pemb_ppn_view.dart';
...
class ValidasiInvDelPembPpnBelumValView
    extends GetView<InvDelPembPpnBelumValController> {
  const ValidasiInvDelPembPpnBelumValView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => InvDelPembPpnBelumValController());
                                              ...
                                              IconButton(
                                                onPressed: () {
                                                  action.show((value) {
                                                    if (value.index == 0) {
                                                      Get.dialog(
                                                        FormValidasiInvDelPembPpnView(
                                                            data: item),
                                                      ).then((value) {
                                                        if (value == true) {
                                                          // pindah tab
                                                          final internal = Get.find<
                                                              InvDelPembPpnController>();
                                                          internal.tab.value =
                                                              1;

                                                          final belum = Get.find<
                                                              InvDelPembPpnBelumValController>();
                                                          belum.listData
                                                              .removeWhere((e) =>
                                                                  e.noHide ==
                                                                  item.noHide);
