...
import 'package:qrm_dev/app/modules/home/controllers/IT/Data%20Akun%20IT/data_akun_it_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/it/data%20akun/create_data_akun_view.dart';
...
class DataAkunItView extends GetView<DataAkunItController> {
  const DataAkunItView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => DataAkunItController());
      ...
      child: Scaffold(
        appBar: CustomAppbar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                Get.to(() => CreateDataAkunView())?.then((data) {
                  if (data != null) {
                    controller.insertData(DataAkun.fromJson(data));
                  }
                });
              },
              icon: Icon(Hi.add01),
