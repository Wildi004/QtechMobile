...
class ValidasiDelPembNonPpnSudahValView
    extends GetView<DelPembNonPpnController> {
  const ValidasiDelPembNonPpnSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => DelPembNonPpnDetailView(data: item))
                              ?.then((value) {
