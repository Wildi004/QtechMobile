...
import 'package:qrm_dev/app/modules/home/controllers/IT/Pengajuan%20It/detail_pengajuan_it_controller.dart';
...
class DetailPengajuanItView extends GetView<DetailPengajuanItController> {
  final PengajuanIt? data;
  final bool showPrintButton;

  const DetailPengajuanItView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => DetailPengajuanItController()..data = data);
