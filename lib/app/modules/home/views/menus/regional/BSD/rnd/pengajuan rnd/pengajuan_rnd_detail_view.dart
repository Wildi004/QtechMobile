...
import 'package:qrm_dev/app/modules/home/controllers/RND/Pengajuan%20RND/pengajuan_rnd_detail_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/rnd/pengajuan%20rnd/cetak%20pengajuan%20rnd/cetak_pengajuan_rnd_view.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class PengajuanRndDetailView extends GetView<PengajuanRndDetailController> {
  final PengajuanIt? data;
  final bool showPrintButton;

  const PengajuanRndDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => PengajuanRndDetailController()..data = data);
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: CustomAppbar(
          title: 'Detail Pengajuan RND',
          actions: [
            if (showPrintButton) // <- Tampilkan hanya kalau true
              IconButton(
                onPressed: () {
                  final cetakController = Get.put(CetakPengajuanRndView());
