...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Inv%20Del%20Po%20Non%20PPN%20Logistik/inv_del_po_non_ppn_belum_val_controller.dart';
...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20logistik%20bali/validasi%20inv%20del%20po%20non%20ppn/form_validasi_inv_del_po_non_ppn_view.dart';
...
class ValidasiInvDelPoNonPpnBelumValView
    extends GetView<InvDelPoNonPpnBelumValController> {
  const ValidasiInvDelPoNonPpnBelumValView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => InvDelPoNonPpnBelumValController());
                                              ...
                                              IconButton(
                                                onPressed: () {
                                                  action.show((value) {
                                                    if (value.index == 0) {
                                                      Get.dialog(
                                                        FormValidasiInvDelPoNonPpnView(
                                                            data: item),
                                                      ).then((value) {
                                                        if (value == true) {
                                                          // pindah tab
                                                          final internal = Get.find<
                                                              InvDelPoNonPpnController>();
                                                          internal.tab.value =
                                                              1;

                                                          final belum = Get.find<
                                                              InvDelPoNonPpnBelumValController>();
                                                          belum.listData
                                                              .removeWhere((e) =>
                                                                  e.noHide ==
                                                                  item.noHide);
