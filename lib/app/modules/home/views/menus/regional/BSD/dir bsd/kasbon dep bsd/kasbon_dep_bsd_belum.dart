...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/kasbon%20dep%20bsd/kasbon_dep_bsd_detail_view.dart';
...
class KasbonDepBsdBelum extends GetView<KasbonDepBsdBelumController> {
  const KasbonDepBsdBelum({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      Get.lazyPut(() => KasbonDepBsdBelumController());
