...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20po%20non%20ppn/form_validasi_po_non_ppn_controller.dart';

class FormValidasiPoNonPpnView extends GetView<FormValidasiPoNonPpnController> {
  final PoNon? data;
  const FormValidasiPoNonPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiPoNonPpnController());
