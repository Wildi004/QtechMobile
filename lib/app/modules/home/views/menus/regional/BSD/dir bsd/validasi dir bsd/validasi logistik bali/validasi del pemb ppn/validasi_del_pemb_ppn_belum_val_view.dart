...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20logistik%20bali/validasi%20del%20pemb%20ppn/form_validasi_del_pemb_ppn_view.dart';
...
class ValidasiDelPembPpnBelumValView
    extends GetView<DelPembPpnBelumValController> {
  const ValidasiDelPembPpnBelumValView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => DelPembPpnBelumValController());
                                              ...
                                              IconButton(
                                                onPressed: () {
                                                  action.show((value) {
                                                    if (value.index == 0) {
                                                      Get.dialog(
                                                        FormValidasiDelPembPpnView(
                                                            data: item),
                                                      ).then((value) {
                                                        if (value == true) {
                                                          // pindah tab
                                                          final internal = Get.find<
                                                              DelPembPpnController>();
                                                          internal.tab.value =
                                                              1;
