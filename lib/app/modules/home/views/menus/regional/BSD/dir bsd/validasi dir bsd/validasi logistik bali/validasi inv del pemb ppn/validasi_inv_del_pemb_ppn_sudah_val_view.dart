...
class ValidasiInvDelPembPpnSudahValView
    extends GetView<InvDelPembPpnController> {
  const ValidasiInvDelPembPpnSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => InvDelPembPpnDetailView(data: item))
                              ?.then((value) {
