...
import 'package:qrm_dev/app/modules/home/controllers/RND/Rab%20RND/rab_rnd_belum_validasi_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/rnd/rab%20rnd/edit_rab_rnd_view.dart';
...
class RabRndBelumValidasiView extends GetView<RabRndBelumValidasiController> {
  const RabRndBelumValidasiView({super.key});

  @override
  Widget build(BuildContext context) {
    final itemWidth = MediaQuery.of(context).size.width - 30;
    Get.lazyPut(() => RabRndBelumValidasiController());
                    ...
                    ...list.generate((item, i) {
                      return ListItemAnimasi(
                        ...
                        child: CustomScalaContainer(
                          child: Touch(
                            onTap: () {
                              Get.to(() => RabRndDetailView(data: item),
                                  arguments: {
                                    'id': item.id.toString(),
                                  });
                            },
