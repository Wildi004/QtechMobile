...
class ValidasiSjInBaliSudahValView
    extends GetView<SuratJalanInternalController> {
  const ValidasiSjInBaliSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => SuratJalanInternalDetailView(data: item))
                              ?.then((value) {
