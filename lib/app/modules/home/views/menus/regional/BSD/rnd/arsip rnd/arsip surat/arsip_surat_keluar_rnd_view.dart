...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/rnd/arsip%20rnd/arsip%20surat/detail_arsip_surat_rnd_view.dart';
...
class ArsipSuratKeluarRndView extends StatelessWidget {
  final ArsipSuratKeluarRndController controller =
      Get.put(ArsipSuratKeluarRndController());

  ArsipSuratKeluarRndView({super.key});
                    ...
                    children: brosur.map((data) {
                      return Column(
                        ...
                        children: [
                          Touch(
                            onTap: () {
                              Get.to(() => DetailArsipSuratRndView(data: data))
                                  ?.then((value) {});
                            },
                            child: Container(
