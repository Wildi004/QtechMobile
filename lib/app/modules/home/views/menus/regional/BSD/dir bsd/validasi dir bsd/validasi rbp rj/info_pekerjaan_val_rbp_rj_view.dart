...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20rbp%20rj/validasi_rbp_rj_belum_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20rbp%20rj/create_validasi_rbp_rj_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/validasi%20dir%20bsd/validasi%20rbp%20rj/validasi_rbp_rj_detail_view.dart';

class InfoPekerjaanValRbpRjView extends StatelessWidget {
  final ProyekRbp? proyek;
  final RbpRb? data;

  const InfoPekerjaanValRbpRjView({super.key, this.proyek, this.data});
          ...
          LzCard(
            children: [
              ...
              InkWell(
                  onTap: () {
                    Get.dialog(
                      CreateValidasiRbpRjView(data: data),
                    ).then((value) {
                      if (value == true) {
                        // pindah tab

                        final belum = Get.find<ValidasiRbpRjBelumController>();
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  if (value == 'info') {
                    Get.to(
                        () => ValidasiRbpRjDetailView(noHide: data?.noHideRbp));
                  }
                },
                itemBuilder: (context) => [
                  const PopupMenuItem(
