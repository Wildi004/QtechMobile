...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Validasi%20Dir%20BSD/validasi%20logistik%20bali/validasi%20inv%20del%20pemb%20non%20ppn/form_validasi_inv_del_pemb_non_ppn_controller.dart';

class FormValidasiInvDelPembNonPpnView
    extends GetView<FormValidasiInvDelPembNonPpnController> {
  final InvDelPembNonPpn? data;
  const FormValidasiInvDelPembNonPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => FormValidasiInvDelPembNonPpnController());
    ...
    return AlertDialog(
      ...
      title: const Text(
        'Validasi Invoice Delivery Pembelian Non PPN',
