...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/rnd/ptj%20rnd/create_ptj_reg_rnd_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/rnd/ptj%20rnd/create_ptj_rnd_view.dart';

class ShowRegionalRnd {
  ...
  static Widget _ptjButton(String label, String type) {
    return Container(
      ...
      child: TextButton(
        onPressed: () {
          if (type == 'Kantor') {
            Get.to(() => CreatePtjRndView(
                  type: 'Kantor',
                ))?.then((data) {
              if (data != null && data is List) {
                final form = Get.find<PtjRndController>();
            ...
            Get.to(() => CreatePtjRegRndView(type: type))?.then((data) {
              if (data != null && data is List) {
