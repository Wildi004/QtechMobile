...
class ValidasiDelPoNonPpnSudahValView extends GetView<DelPoNonController> {
  const ValidasiDelPoNonPpnSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => DelPoNonDetailView(data: item))
                              ?.then((value) {
