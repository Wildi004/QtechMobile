...
import 'package:qrm_dev/app/modules/home/controllers/IT/PTJ%20IT/create_ptj_it_controller.dart';
...
class CreatePtjRegItView extends GetView<CreatePtjItController> {
  final String type;
  const CreatePtjRegItView({super.key, required this.type});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePtjItController(type));
