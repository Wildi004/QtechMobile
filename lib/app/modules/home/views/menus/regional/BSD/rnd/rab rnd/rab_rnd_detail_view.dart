...
import 'package:qrm_dev/app/modules/home/controllers/RND/Rab%20RND/cetak%20RND/cetak_rnd_view.dart';
import 'package:qrm_dev/app/modules/home/controllers/RND/Rab%20RND/rab_rnd_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class RabRndDetailView extends GetView<RabRndDetailController> {
  final RabIt? data;

  const RabRndDetailView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => RabRndDetailController()..data = data);
    ...
    return Scaffold(
      ...
      appBar: CustomAppbar(
        title: 'Detail RAB RND',
        actions: [
          IconButton(
            onPressed: () {
              final cetakController = Get.put(CetakRndView());
