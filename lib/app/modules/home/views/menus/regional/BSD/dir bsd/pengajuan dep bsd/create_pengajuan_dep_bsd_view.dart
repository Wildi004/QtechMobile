...
import 'package:qrm_dev/app/modules/home/controllers/BSD/Pengajuan%20Dev%20Bsd/create_pengajuan_dep_bsd_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class CreatePengajuanDepBsdView
    extends GetView<CreatePengajuanDepBsdController> {
  const CreatePengajuanDepBsdView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePengajuanDepBsdController());
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        if (!controller.isSubmitted.value && controller.created != null) {
          await controller.deletePengajuan(controller.created!.noHide!);
        }
      },
      child: Scaffold(
        appBar: CustomAppbar(
          title: 'Form Pengajuan BSD',
          actions: [
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "Detail Pengajuan ${controller.formItems.length - i}",
                          style: TextStyle(
                            fontSize: 16,
                          ...
                          LzCard(
                            ...
                            children: [
                              ...
                              LzForm.select(
                                ...
                                hint: 'Pilih No Pengajuan',
                                model: forms.key('no_pengajuan_dep'),
