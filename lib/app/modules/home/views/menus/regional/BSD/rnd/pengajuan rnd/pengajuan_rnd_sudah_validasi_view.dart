...
class PengajuanRndSudahValidasiView extends GetView<PengajuanRndController> {
  const PengajuanRndSudahValidasiView({super.key});
                ...
                ...data.generate((item, i) {
                  return ListItemAnimasi(
                    ...
                    child: CustomScalaContainer(
                      child: Touch(
                        onTap: () {
                          Get.to(() => PengajuanRndDetailView(
                                data: item,
                                showPrintButton: true,
                              ))?.then((value) {
                            if (value != null) {
                              controller.updateData(
                                  PengajuanIt.fromJson(value), item.noHide!);
                            }
                          });
                        },
                        margin: Ei.only(b: 10),
