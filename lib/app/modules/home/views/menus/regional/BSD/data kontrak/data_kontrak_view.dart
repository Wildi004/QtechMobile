...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/data%20kontrak/data_kontrak_detail_view.dart';
...
class DataKontrakView extends GetView<DataKontrakController> {
  const DataKontrakView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => DataKontrakController());
                  ...
                  children: [
                    ...
                    ...data.generate((item, i) {
                      return ListItemAnimasi(
                        index: i,
                        beginOffset:
                            const Offset(-0.3, 0), // dari kiri ke kanan
                        child: Droplist(
                          options: options,
                          builder: (key, action) {
                              ...
                              child: Touch(
                                ...
                                onTap: () {
                                  action.show((value) async {
                                    Get.to(() =>
                                            DataKontrakDetailView(data: item))
                                        ?.then((value) {});
                                    if (value.index == 0) {
...
//                                   if (value.index == 0) {
//                                   } else if (value.index == 1) {
//                                     // Get.to(() => CreateDataAkunView(data: item))
//                                     //     ?.then((value) {
//                                     //   if (value != null) {
