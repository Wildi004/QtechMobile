...
import 'package:qrm_dev/app/modules/home/controllers/BSD/surat%20menyurat%20Bsd/surat_masuk_bsd_controller.dart';
...
class DetailSuratBsdView extends GetView<SuratMasukBsdController> {
  final SuratMasuk? data;

  const DetailSuratBsdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => SuratMasukBsdController());
