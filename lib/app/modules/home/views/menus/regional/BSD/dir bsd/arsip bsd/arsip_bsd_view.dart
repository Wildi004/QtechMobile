...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/arsip%20bsd/arsip_bsd_detail_view.dart';
...
class ArsipBsdView extends GetView<ArsipBsdController> {
  const ArsipBsdView({super.key});
              ...
              children: [
                ...
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                      onTap: () {
                        Get.to(() => ArsipBsdDetailView(data: item))
                            ?.then((value) {});
                      },
                      margin: Ei.only(b: 10),
                      child: Container(
