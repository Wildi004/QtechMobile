...
class ValidasiInvDelPoPpnSudahValView extends GetView<InvDelPoPpnController> {
  const ValidasiInvDelPoPpnSudahValView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => InvDelPoPpnDetailView(data: item))
                              ?.then((value) {
