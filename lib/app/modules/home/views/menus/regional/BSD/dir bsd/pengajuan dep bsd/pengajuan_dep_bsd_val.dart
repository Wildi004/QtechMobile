...
import 'package:qrm_dev/app/modules/home/views/menus/regional/BSD/dir%20bsd/pengajuan%20dep%20bsd/pengajuan_dep_bsd_detail_view.dart';
...
class PengajuanDepBsdVal extends GetView<PengajuanDevBsdController> {
  const PengajuanDepBsdVal({super.key});
                ...
                ...data.generate((item, i) {
                  return ListItemAnimasi(
                    ...
                    child: CustomScalaContainer(
                      child: Touch(
                        onTap: () {
                          Get.to(() => PengajuanDepBsdDetailView(
                                data: item,
