...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Stok%20Material%20Logistik%20Jkt/create_stok_material_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateStokMaterialLogistikJktView
    extends GetView<CreateStokMaterialJktController> {
  final AlatProyek? data;
  const CreateStokMaterialLogistikJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateStokMaterialJktController());
