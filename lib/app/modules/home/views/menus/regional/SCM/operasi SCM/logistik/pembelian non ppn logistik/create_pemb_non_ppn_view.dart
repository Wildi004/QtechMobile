...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Pembelian%20Non%20PPN%20Logistik/create_pemb_non_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreatePembNonPpnView extends GetView<CreatePembNonPpnController> {
  final PembNonPpn? data;
  const CreatePembNonPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePembNonPpnController());
                    ...
                    return LzCard(
                      ...
                      children: [
                        ...
                        LzForm.select(
                          ...
                          style:
                              OptionPickerStyle(maxLines: 2, withSearch: true),
                          label: 'Kode Material',
