...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Inv%20Del%20Po%20PPN%20Logiastik/inv_del_po_ppn_detail_controller.dart';
...
class InvDelPoPpnDetailView extends GetView<InvDelPoPpnDetailController> {
  final InvDelPoPpn? data;
  final bool showPrintButton;

  const InvDelPoPpnDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(InvDelPoPpnDetailController());
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: CustomAppbar(
          title: 'Detail Inv Delivery PO PPN',
          actions: [
            IconButton(
              onPressed: () {
