...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Surat%20menyurat%20logistik/surat_masuk_logistik_controller.dart';
...
class SuratMasukLogistikView extends GetView<SuratMasukLogistikController> {
  const SuratMasukLogistikView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => SuratMasukLogistikController());
