...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Pembelian%20PPN%20Jkt/pemb_ppn_jkt_detail_controller.dart';
...
class PembPpnJktDetailView extends GetView<PembPpnJktDetailController> {
  final PembelianPpn? data;
  final bool showPrintButton;

  const PembPpnJktDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(PembPpnJktDetailController());
