...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik%20jakarta/pembelian%20ppn%20jkt/pemb_ppn_jkt_detail_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/pembelian%20ppn%20logistik/edit_pemb_ppn_view.dart';
...
class PembPpnJktBelumValidasiView
    extends GetView<PembPpnJktBelumValidasiController> {
  const PembPpnJktBelumValidasiView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => PembPpnJktBelumValidasiController());
                                                    ...
                                                    action.show((value) {
                                                      if (value.index == 0) {
                                                        ...
                                                        Get.to(() =>
                                                          ...
                                                          if (value != null) {
                                                            final form = Get.find<
                                                                PembPpnJktBelumValidasiController>();
                                                            form.updateData(
                                                                PembelianPpn
                                                                    .fromJson(
                                                                        value),
