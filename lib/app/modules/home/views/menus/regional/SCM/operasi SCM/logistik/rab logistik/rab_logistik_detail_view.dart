...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Rab%20logistik/rab_logistik_detail_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/rab%20logistik/cetak%20logistik/cetak_rab_logistik.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class RabLogistikDetailView extends GetView<RabLogistikDetailController> {
  final RabLogistik? data;

  const RabLogistikDetailView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => RabLogistikDetailController()..data = data);
      ...
      child: Scaffold(
        ...
        appBar: CustomAppbar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                final cetakController = Get.put(CetakRabLogistik());
