...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Surat%20Jalan%20Logistik%20Jkt/surat%20jalan%20eksternal%20Jkt%20Non/surat_jalan_exst_jkt_non_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class SuratJalanExstJktNonDetailView
    extends GetView<SuratJalanExstJktNonDetailController> {
  final SuratJalanExstNon? data;
  final bool showPrintButton;

  const SuratJalanExstJktNonDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(SuratJalanExstJktNonDetailController());
