...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/rbp%20rj/rbp_rj_logistik_detail_view.dart';

class InfoPekerjaanRbpRjView extends StatelessWidget {
  final ProyekRbp? proyek;
  final RbpRb? data;

  const InfoPekerjaanRbpRjView({super.key, this.proyek, this.data});
        ...
        children: [
          LzCard(
            children: [
              ...
              ValidasiRow(label: 'Validasi BSD', status: data?.statusBsd),
              ValidasiRow(
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  if (value == 'info') {
                    Get.to(
                        () => RbpRjLogistikDetailView(noHide: data?.noHideRbp));
                  }
                },
                itemBuilder: (context) => [
                  const PopupMenuItem(
