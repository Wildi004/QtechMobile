...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Delivery%20Pembelian%20PPN%20Logistik/edit_del_pemb_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class EditDeliveryPembPpnView extends GetView<EditDelPembPpnController> {
  final DelPembPpn? data;
  const EditDeliveryPembPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => EditDelPembPpnController());
    ...
    return Scaffold(
        appBar: CustomAppbar(
          title: 'Edit Delivery Pembelian PPN',
          actions: [
            IconButton(
              onPressed: () {
                controller.onSubmit();
