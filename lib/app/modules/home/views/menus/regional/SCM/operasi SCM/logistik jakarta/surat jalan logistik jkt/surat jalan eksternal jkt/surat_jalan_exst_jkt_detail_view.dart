...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Surat%20Jalan%20Logistik%20Jkt/surat%20jalan%20exst%20Jkt/surat_jalan_exst_jkt_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class SuratJalanExstJktDetailView
    extends GetView<SuratJalanExstJktDetailController> {
  final SuratJalanExst? data;
  final bool showPrintButton;

  const SuratJalanExstJktDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(SuratJalanExstJktDetailController());
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: CustomAppbar(
          title: 'Detail Surat Jalan Eksternal',
          actions: [
            // IconButton(
            //   onPressed: () {
