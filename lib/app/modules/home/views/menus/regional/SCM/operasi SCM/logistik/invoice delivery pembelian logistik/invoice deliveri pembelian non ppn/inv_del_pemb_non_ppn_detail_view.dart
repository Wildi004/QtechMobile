...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Invoice%20Delivery%20Pembelian%20Non%20PPN/inv_del_pemb_non_ppn_detail_controller.dart';
...
class InvDelPembNonPpnDetailView
    extends GetView<InvDelPembNonPpnDetailController> {
  final InvDelPembNonPpn? data;
  final bool showPrintButton;

  const InvDelPembNonPpnDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(InvDelPembNonPpnDetailController());
