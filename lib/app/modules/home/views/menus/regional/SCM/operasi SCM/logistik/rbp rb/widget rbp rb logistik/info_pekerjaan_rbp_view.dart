...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/rbp%20rb/rbp_rb_logistik_detail_view.dart';

class ProyekDetailCard extends StatelessWidget {
  final ProyekRbp? proyek;
  final RbpRb? data;

  const ProyekDetailCard({super.key, this.proyek, this.data});
            ...
            children: [
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (value) {
                  if (value == 'info') {
                    Get.to(
                        () => RbpRbLogistikDetailView(noHide: data?.noHideRbp));
                  }
                },
                itemBuilder: (context) => [
                  const PopupMenuItem(
