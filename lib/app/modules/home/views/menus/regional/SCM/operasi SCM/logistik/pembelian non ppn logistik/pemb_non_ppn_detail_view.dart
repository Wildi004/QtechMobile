...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Pembelian%20Non%20PPN%20Logistik/pemb_non_ppn_detail_controller.dart';
...
class PembNonPpnDetailView extends GetView<PembNonPpnDetailController> {
  final PembNonPpn? data;
  final bool showPrintButton;

  const PembNonPpnDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(PembNonPpnDetailController());
