...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Service%20Aset%20Logistik/edit_service_aset_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class EditServiceAsetLogistikView
    extends GetView<EditServiceAsetLogistikController> {
  final ServiceAset? data;
  const EditServiceAsetLogistikView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => EditServiceAsetLogistikController());
