...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Deliveri%20PO%20PPN/cetak_del_po_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/delivery%20po%20ppn/cetak%20delivery/print_del_po_ppn.dart';

class CetakDelPoPpnView extends GetView<CetakDelPoController> {
  const CetakDelPoPpnView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CetakDelPoController());
                          ...
                          child: LzButton(
                            ...
                            onTap: () async {
                              ...
                              final printController =
                                  Get.put(CetakDelPoPpnPrintController());
