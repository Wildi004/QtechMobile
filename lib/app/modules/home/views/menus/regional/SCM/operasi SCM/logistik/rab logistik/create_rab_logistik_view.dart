...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Rab%20logistik/create_rab_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class CreateRabLogistikView extends GetView<CreateRabLogistikController> {
  const CreateRabLogistikView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateRabLogistikController());
