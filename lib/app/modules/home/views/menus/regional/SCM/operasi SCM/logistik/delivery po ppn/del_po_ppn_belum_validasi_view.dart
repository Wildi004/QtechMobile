...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/delivery%20po%20ppn/edit_del_po_ppn_view.dart';
...
class DelPoPpnBelumValidasiView extends GetView<DelPoPpnBelumValController> {
  const DelPoPpnBelumValidasiView({super.key});
                                        ...
                                        onPressed: () {
                                          action.show((value) {
                                            if (value.index == 0) {
                                              ...
                                              Get.to(() => EditDelPoPpnView(
                                                  data: item))?.then((value) {
                                                if (value != null) {
                                                  final form = Get.find<
                                                      DelPoPpnBelumValController>();
                                                  form.updateData(
                                                      DelPoPpn.fromJson(value),
                                                      item.noHide!);
                                                }
                                              });
