...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Kendaraan%20Logistik%20jkt/create_kendaraan_logistik_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateKendaraanLogistikJktView
    extends GetView<CreateKendaraanLogistikJktController> {
  final KendaraanLogistik? data;
  const CreateKendaraanLogistikJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateKendaraanLogistikJktController());
