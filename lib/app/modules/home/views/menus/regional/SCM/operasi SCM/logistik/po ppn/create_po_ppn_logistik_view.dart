...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Po%20Ppn/create_po_ppn_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreatePoPpnLogistikView extends GetView<CreatePoPpnLogistikController> {
  final PoPpn? data;
  const CreatePoPpnLogistikView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePoPpnLogistikController());
