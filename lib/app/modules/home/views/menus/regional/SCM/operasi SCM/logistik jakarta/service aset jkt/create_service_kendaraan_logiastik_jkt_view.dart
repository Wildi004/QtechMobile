...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Service%20Aset%20Logistik%20jkt/create_sercice_kendaraan_logistik_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateServiceKendaraanLogiastikJktView
    extends GetView<CreateSerciceKendaraanLogistikJktController> {
  final ServiceAset? data;
  const CreateServiceKendaraanLogiastikJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateSerciceKendaraanLogistikJktController());
