...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Ptj%20Legal/create_ptj_legal_controller.dart';
...
class CreatePtjLegalView extends GetView<CreatePtjLegalController> {
  final String type;
  const CreatePtjLegalView({super.key, required this.type});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePtjLegalController(type));
