...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/service%20aset/create_service_aset_logistik_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/service%20aset/create_service_kendaraan_logiastik_view.dart';
...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/service%20aset/service_aset_detail_logistik_view.dart';
...
class ServiceAsetLogistikView extends GetView<ServiceAsetLogistikController> {
  const ServiceAsetLogistikView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => ServiceAsetLogistikController());
                ...
                CustomShowMenu.showDialogWithOptions(
                  ...
                  options: [
                    DialogOption(
                        ...
                        onTap: () =>
                            Get.to(() => CreateServiceAsetLogistikView())
                                ?.then((data) {
                              if (data != null) {
                                controller
                    ...
                    DialogOption(
                        ...
                        onTap: () =>
                            Get.to(() => CreateServiceKendaraanLogiastikView())
                                ?.then((data) {
                              if (data != null) {
                                controller
                                    .insertData(ServiceAset.fromJson(data));
                  ...
                  ...data.generate((item, i) {
                    return CustomScalaContainer(
                      child: Touch(
                        onTap: () {
                          Get.to(() =>
                                  ServiceAsetDetailLogistikView(data: item))
                              ?.then((value) {});
                        },
                        margin: Ei.only(b: 10),
                        child: Container(
