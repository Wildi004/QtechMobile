...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Alat%20Proyek/edit_alat_proyek_logistik_controller.dart';
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Alat%20Proyek/edit_alat_proyek_log_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class EditAlatProyekLogJktView extends GetView<EditAlatProyekLogJktController> {
  final AlatProyekLogJkt? data;
  const EditAlatProyekLogJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => EditAlatProyekLogJktController());
    if (!Get.isRegistered<EditAlatProyekLogJktController>()) {
      Get.lazyPut(() => EditAlatProyekLogistikController());
    }
        ...
        body: LzListView(
          ...
          children: [
            ...
            LzForm.select(
                ...
                onChange: (value) {
                  controller.forms.set('pm', Option(''));
                }),
            LzForm.select(
