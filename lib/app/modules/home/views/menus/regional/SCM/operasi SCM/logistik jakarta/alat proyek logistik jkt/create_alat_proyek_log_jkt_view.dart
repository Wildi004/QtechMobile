...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Alat%20Proyek/create_alat_proyek_log_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateAlatProyekLogJktView
    extends GetView<CreateAlatProyekLogJktController> {
  final AlatProyekLogJkt? data;
  const CreateAlatProyekLogJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateAlatProyekLogJktController());
    ...
    return Scaffold(
        appBar: CustomAppbar(
          title: 'Form Add Alat Proyek Jakarta',
          actions: [
            IconButton(
              onPressed: () {
