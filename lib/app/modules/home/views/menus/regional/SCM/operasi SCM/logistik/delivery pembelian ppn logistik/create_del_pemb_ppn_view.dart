...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Delivery%20Pembelian%20PPN%20Logistik/create_del_pemb_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateDelPembPpnView extends GetView<CreateDelPembPpnController> {
  final DelPembPpn? data;
  const CreateDelPembPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateDelPembPpnController());
