...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Pembelian%20PPN%20Jkt/create_pemb_ppn_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreatePembPpnJktView extends GetView<CreatePembPpnJktController> {
  final PembelianPpn? data;
  const CreatePembPpnJktView({super.key, this.data});
  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePembPpnJktController());
