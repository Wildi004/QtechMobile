...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Deliveri%20PO%20PPN/del_po_ppn_detail_controller.dart';
...
class DelPoPpnDetailView extends GetView<DelPoPpnDetailController> {
  final DelPoPpn? data;
  final bool showPrintButton;
  final String? noDelpo;

  const DelPoPpnDetailView(
      {super.key, this.data, this.showPrintButton = false, this.noDelpo});

  @override
  Widget build(BuildContext context) {
    Get.put(DelPoPpnDetailController());
