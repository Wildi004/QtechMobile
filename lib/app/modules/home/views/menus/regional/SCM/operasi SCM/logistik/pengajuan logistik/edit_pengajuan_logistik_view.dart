...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Pengajuan%20Logistik/edit_pengajuan_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditPengajuanLogistikView
    extends GetView<EditPengajuanLogistikController> {
  final PengajuanLogistik? data;

  const EditPengajuanLogistikView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditPengajuanLogistikController());
