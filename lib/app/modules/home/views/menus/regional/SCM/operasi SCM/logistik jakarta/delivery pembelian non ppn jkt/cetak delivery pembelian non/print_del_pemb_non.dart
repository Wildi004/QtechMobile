...
class PrintDelPembNon extends GetxController {
  ...
  Future<void> cetakDelPoPpn(Map<String, dynamic> query) async {
    try {
      ...
      final uri =
          Uri.parse('${baseUrl}logistik/delivery/pembelian-non-ppn/cetak')
      ...
      if (statusCode != 200) {
        ...
        Get.snackbar(
          'Gagal',
          'Tidak ada data delivery pembelian non ppn yang ditemukan untuk filter ini.',
      ...
      final deliveryDir = Directory('${dir.path}/delivery/pemb/non');
      ...
      if (Get.isDialogOpen ?? false) Get.back();
      debugPrint(
          '[LOG] Terjadi error saat mencetak delivery pembelian non ppn: $e');
      Get.snackbar(
        'Error',
        'Terjadi kesalahan saat mencetak delivery pembelian non ppn.',
        backgroundColor: const Color.fromARGB(255, 171, 81, 74),
        colorText: Colors.white,
        snackPosition: SnackPosition.TOP,
        duration: const Duration(seconds: 3),
