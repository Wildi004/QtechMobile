...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Surat%20Jalan%20Logistik%20Jkt/surat%20jalan%20internal%20jkt/surat_jalan_internal_jkt_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class SuratJalanInternalJktDetailView
    extends GetView<SuratJalanInternalJktDetailController> {
  final SuratJalanInternal? data;
  final bool showPrintButton;
  final String? noInt;

  const SuratJalanInternalJktDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(SuratJalanInternalJktDetailController());
