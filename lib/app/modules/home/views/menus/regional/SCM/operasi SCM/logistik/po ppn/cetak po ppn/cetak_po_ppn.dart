...
class CetakPoPpn extends GetxController with Apis {
  ...
  Future<void> getDataCetak(String? noHide) async {
    try {
      ...
      debugPrint('[LOG] Memanggil getDataCetak dengan ID: $noHide');

      final uri = Uri.parse('${baseUrl}logistik/po-ppn/cetak/$noHide');
