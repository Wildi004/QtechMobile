...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Pembelian%20Non%20PPN%20Logistik/edit_pemb_non_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class EditPembNonPpnView extends GetView<EditPembNonPpnController> {
  final PembNonPpn? data;
  const EditPembNonPpnView({super.key, this.data});
  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => EditPembNonPpnController());
    ...
    return Scaffold(
        ...
        body: LzListView(
          ...
          children: [
            LzForm.input(
              hint: 'Masukkan NO. Pembelian Non PPN',
              label: 'NO. Pembelian',
              maxLines: 99,
            ...
            LzForm.select(
              ...
              onTap: () async {
                final data = await controller.getPemb();
                controller.forms
