...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Surat%20Jalan%20Logistik/surat%20jalan%20exst/surat_jalan_exst_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';

class SuratJalanExstDetailView extends GetView<SuratJalanExstDetailController> {
  final SuratJalanExst? data;
  final bool showPrintButton;

  const SuratJalanExstDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(SuratJalanExstDetailController());
