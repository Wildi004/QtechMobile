...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Ptj%20Legal/ptj_legal_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class PtjLegalDetailView extends GetView<PtjLegalDetailController> {
  final PtjLegal? data;

  const PtjLegalDetailView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => PtjLegalDetailController()..data = data);
