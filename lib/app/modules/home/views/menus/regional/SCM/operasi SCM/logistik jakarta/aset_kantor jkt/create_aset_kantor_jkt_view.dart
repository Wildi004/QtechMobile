...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Aset%20Kantor/create_aset_kantor_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateAsetKantorJktView extends GetView<CreateAsetKantorJktController> {
  final AsetKantorLogJkt? data;
  const CreateAsetKantorJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateAsetKantorJktController());
