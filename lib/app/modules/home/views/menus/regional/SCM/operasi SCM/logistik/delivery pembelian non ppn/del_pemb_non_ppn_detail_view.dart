...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Delivery%20Pembelian%20Non%20PPN%20Logistik/del_pemb_non_ppn_detail_controller.dart';
...
class DelPembNonPpnDetailView extends GetView<DelPembNonPpnDetailController> {
  final DelPembNonPpn? data;
  final bool showPrintButton;

  const DelPembNonPpnDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(DelPembNonPpnDetailController());
