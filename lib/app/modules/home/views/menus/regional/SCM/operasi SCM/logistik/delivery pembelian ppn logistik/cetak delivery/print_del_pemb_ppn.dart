...
class PrintDelPembPpn extends GetxController {
  ...
  Future<void> cetakDelPoPpn(Map<String, dynamic> query) async {
    try {
      ...
      final uri = Uri.parse('${baseUrl}logistik/delivery/pembelian-ppn/cetak')
      ...
      if (statusCode != 200) {
        ...
        Get.snackbar(
          'Gagal',
          'Tidak ada data Delivery Pembelian yang ditemukan untuk filter ini.',
      ...
      final deliveryDir = Directory('${dir.path}/delivery/pemb');
      ...
      if (Get.isDialogOpen ?? false) Get.back();
      debugPrint('[LOG] Terjadi error saat mencetak Delivery Pembelian: $e');
      Get.snackbar(
        'Error',
        'Terjadi kesalahan saat mencetak Delivery Pembelian.',
        backgroundColor: const Color.fromARGB(255, 171, 81, 74),
        colorText: Colors.white,
        snackPosition: SnackPosition.TOP,
        duration: const Duration(seconds: 3),
