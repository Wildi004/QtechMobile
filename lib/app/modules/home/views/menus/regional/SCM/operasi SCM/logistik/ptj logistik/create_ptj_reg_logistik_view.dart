...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/PTJ%20Logistik/create_ptj_logistik_controller.dart';
...
class CreatePtjRegLogistikView extends GetView<CreatePtjLogistikController> {
  final String type;
  const CreatePtjRegLogistikView({super.key, required this.type});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePtjLogistikController(type));
                        ...
                        return LzCard(
                          ...
                          children: [
                            ...
                            LzForm.select(
                              label: 'Pilih Proyek',
                              hint: 'Pilih proyek',
                              model: controller.forms.key('proyek_item_id'),
                              style: OptionPickerStyle(
                                  maxLines: 3, withSearch: true),
                              onTap: () async {
                                await controller.openProyek();
                              },
                            ),
                            Intrinsic(
                              gap: 10,
