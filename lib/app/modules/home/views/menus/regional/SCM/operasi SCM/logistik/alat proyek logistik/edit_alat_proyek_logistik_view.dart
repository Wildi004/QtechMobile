...
class EditAlatProyekLogistikView
    extends GetView<EditAlatProyekLogistikController> {
  final AlatProyek? data;
  const EditAlatProyekLogistikView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<EditAlatProyekLogistikController>()) {
