...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik%20jakarta/surat%20jalan%20logistik%20jkt/surat%20jalan%20internal%20jkt/surat_jalan_internal_jkt_detail_view.dart';
import 'package:qrm_dev/app/widgets/custom_decoration.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_scala_container.dart';
import 'package:qrm_dev/app/widgets/custom_search_query.dart';

class SuratJalanInternalJktSudahValView
    extends GetView<SuratJalanInternalJktController> {
  const SuratJalanInternalJktSudahValView({super.key});
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          action.show((value) {
                                            if (value.index == 0) {
                                              Get.to(() =>
                                                  SuratJalanInternalJktDetailView(
                                                      data: item))?.then(
                                                  (value) {
                                                if (int.tryParse(
                                                        item.noHide!) !=
