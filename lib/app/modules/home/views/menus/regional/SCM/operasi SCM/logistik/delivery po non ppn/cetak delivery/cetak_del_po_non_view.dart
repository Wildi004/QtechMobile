...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Del%20PO%20Non%20PPN/cetak_del_po_non_controller.dart';
...
class CetakDelPoNonView extends GetView<CetakDelPoNonController> {
  const CetakDelPoNonView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CetakDelPoNonController());
