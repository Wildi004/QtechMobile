...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Inv%20Del%20Po%20PPN%20Logiastik/create_inv_del_po_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateInvDelPoPpnView extends GetView<CreateInvDelPoPpnController> {
  final InvDelPoPpn? data;
  const CreateInvDelPoPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateInvDelPoPpnController());
