...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Invoice%20Delivery%20Pembelian%20PPN/create_inv_del_pemb_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateInvDelPembView extends GetView<CreateInvDelPembPpnController> {
  final InvDelPembPpn? data;
  const CreateInvDelPembView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateInvDelPembPpnController());
