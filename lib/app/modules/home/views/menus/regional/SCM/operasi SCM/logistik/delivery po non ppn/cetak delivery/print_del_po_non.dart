...
class PrintDelPoNon extends GetxController {
  ...
  Future<void> cetakDelPoPpn(Map<String, dynamic> query) async {
    try {
      ...
      final uri = Uri.parse('${baseUrl}logistik/delivery/po-non-ppn/cetak')
      ...
      if (statusCode != 200) {
        ...
        Get.snackbar(
          'Gagal',
          'Tidak ada data Delivery PO NON PPN yang ditemukan untuk filter ini.',
      ...
      final deliveryDir = Directory('${dir.path}/delivery/po-non');
      ...
      if (Get.isDialogOpen ?? false) Get.back();
      debugPrint('[LOG] Terjadi error saat mencetak Delivery PO NON PPN: $e');
      Get.snackbar(
        'Error',
        'Terjadi kesalahan saat mencetak Delivery PO NON PPN.',
        backgroundColor: const Color.fromARGB(255, 171, 81, 74),
        colorText: Colors.white,
        snackPosition: SnackPosition.TOP,
        duration: const Duration(seconds: 3),
