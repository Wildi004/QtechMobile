...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/pembelian%20non%20ppn%20logistik/create_pemb_non_ppn_view.dart';
...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/pembelian%20non%20ppn%20logistik/pemb_non_ppn_belum_validasi_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/pembelian%20non%20ppn%20logistik/pemn_non_ppn_sudah_validasi_view.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class PembNonPpnView extends GetView<PembNonPpnController> {
  const PembNonPpnView({super.key});
    ...
    return Scaffold(
      appBar: CustomAppbar(
        ...
        actions: [
          IconButton(
            onPressed: () {
              Get.to(() => CreatePembNonPpnView())?.then((data) {
                if (data != null) {
          ...
          Expanded(
            child: Obx(() {
              switch (controller.tab.value) {
                case 0:
                  return PembNonPpnBelumValidasiView();
                case 1:
                  return PemnNonPpnSudahValidasiView();
                case 2:
