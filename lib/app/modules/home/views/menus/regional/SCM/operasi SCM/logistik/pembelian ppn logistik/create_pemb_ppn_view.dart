...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Pembelian%20PPN/create_pemb_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreatePembPpnView extends GetView<CreatePembPpnController> {
  final PembelianPpn? data;
  const CreatePembPpnView({super.key, this.data});
  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePembPpnController());
