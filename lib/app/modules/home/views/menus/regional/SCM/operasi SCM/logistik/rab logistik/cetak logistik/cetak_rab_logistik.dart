...
class CetakRabLogistik extends GetxController with Apis {
  final String baseUrl = AppConfig.baseUrl;

  /// Fungsi cetak RAB it berdasarkan ID
  Future<void> getDataCetak(int? id) async {
    try {
      Get.dialog(
      ...
      debugPrint('[LOG] Memanggil getDataCetak dengan ID: $id');

      final uri = Uri.parse('${baseUrl}logistik/rab/cetak/$id');
      ...
      final filePath =
          '${dir.path}/rab_${DateTime.now().millisecondsSinceEpoch}.pdf';
