...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Pembelian%20Non%20PPN%20Logistik%20Jkt/pemb_jkt_non_ppn_detail_controller.dart';
...
class PembNonPpnJktDetailView extends GetView<PembJktNonPpnDetailController> {
  final PembNonPpn? data;
  final bool showPrintButton;

  const PembNonPpnJktDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(PembJktNonPpnDetailController());
    ...
    return SafeArea(
      ...
      child: Scaffold(
        appBar: CustomAppbar(
          title: 'Detail Pembelian Non PPN',
          actions: [
            IconButton(
              onPressed: () {
