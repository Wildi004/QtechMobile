...
class CetakPoNonPpnView extends GetxController {
  final String baseUrl = AppConfig.baseUrl;

  Future<void> cetakPrintPoNonPpn(Map<String, dynamic> query) async {
    try {
      Get.dialog(
      ...
      debugPrint('[LOG] 🔹 Memanggil cetakPrintPoNonPpn dengan query: $query');

      final uri = Uri.parse('${baseUrl}logistik/po-non-ppn/cetak').replace(
        queryParameters:
