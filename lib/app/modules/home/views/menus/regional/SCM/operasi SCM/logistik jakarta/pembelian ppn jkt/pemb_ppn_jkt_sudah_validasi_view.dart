...
class PembPpnJktSudahValidasiView extends GetView<PembelianPpnJktController> {
  const PembPpnJktSudahValidasiView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => PembPpnJktDetailView(data: item))
                              ?.then((value) {
