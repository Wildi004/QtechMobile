...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Rab%20Legal/rab_legal_detail_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/legal/rab%20legal/cetak%20legal/cetak_legal.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class RabLegalDetailView extends GetView<RabLegalDetailController> {
  final RabLegal? data;

  const RabLegalDetailView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => RabLegalDetailController()..data = data);
      ...
      child: Scaffold(
        ...
        appBar: CustomAppbar(
          ...
          actions: [
            IconButton(
              onPressed: () {
                final cetakController = Get.put(CetakLegal());
