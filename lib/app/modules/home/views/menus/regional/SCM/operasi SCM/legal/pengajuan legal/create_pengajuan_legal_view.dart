...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Pengajuan%20Legal/create_pengajuan_legal_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class CreatePengajuanLegalView extends GetView<CreatePengajuanLegalController> {
  const CreatePengajuanLegalView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePengajuanLegalController());
