...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Rab%20Legal/rab_legal_belum_validasi_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/legal/rab%20legal/edit_legal_view.dart';
...
class RabLegalBelumValidasiView
    extends GetView<RabLegalBelumValidasiController> {
  const RabLegalBelumValidasiView({super.key});

  @override
  Widget build(BuildContext context) {
    final itemWidth = MediaQuery.of(context).size.width - 30;
    Get.lazyPut(() => RabLegalBelumValidasiController());
                                  ...
                                  children: [
                                    IconButton(
                                      icon: const Icon(Hi.edit01,
                                          color: Colors.white),
                                      onPressed: () {
                                        Get.to(() => EditLegalView(data: item))
                                            ?.then((value) {
                                          if (value != null &&
                                              value is Map<String, dynamic>) {
                                            controller.updateData(
                                                RabLegal.fromJson(value),
                                                item.id!);
                                          }
                                        });
                                      },
