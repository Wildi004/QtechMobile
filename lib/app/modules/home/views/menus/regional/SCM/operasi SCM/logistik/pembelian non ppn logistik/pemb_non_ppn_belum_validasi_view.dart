...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/pembelian%20non%20ppn%20logistik/pemb_non_ppn_detail_view.dart';
...
class PembNonPpnBelumValidasiView
    extends GetView<PembNonPpnBelumValidasiController> {
  const PembNonPpnBelumValidasiView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Unfocuser(
      child: Obx(() {
        Get.lazyPut(() => PembNonPpnBelumValidasiController());
                                                    ...
                                                    action.show((value) {
                                                      if (value.index == 0) {
                                                        ...
                                                        Get.to(() =>
                                                          ...
                                                          if (value != null) {
                                                            final form = Get.find<
                                                                PembNonPpnBelumValidasiController>();
                                                            form.updateData(
                                                                PembNonPpn
                                                                    .fromJson(
                                                                        value),
