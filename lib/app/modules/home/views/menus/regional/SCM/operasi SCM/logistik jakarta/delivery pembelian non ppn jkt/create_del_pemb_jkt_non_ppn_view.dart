...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Delivery%20Pembelian%20Non%20PPN%20Jkt/create_del_pemb_jkt_non_ppn_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateDelPembJktNonPpnView
    extends GetView<CreateDelPembJktNonPpnController> {
  final DelPembNonPpn? data;
  const CreateDelPembJktNonPpnView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateDelPembJktNonPpnController());
