...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Ptj%20Legal/create_ptj_reg_legal_controller.dart';
...
class CreatePtjRegLegalView extends GetView<CreatePtjRegLegalController> {
  final String type;
  const CreatePtjRegLegalView({super.key, required this.type});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePtjRegLegalController(type));
