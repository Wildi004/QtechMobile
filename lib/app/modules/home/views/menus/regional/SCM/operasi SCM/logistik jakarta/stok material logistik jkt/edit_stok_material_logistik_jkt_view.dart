...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Stok%20Material%20Logistik%20Jkt/edit_stok_material_logistik_jkt_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class EditStokMaterialLogistikJktView
    extends GetView<EditStokMaterialLogistikJktController> {
  final StokMaterial? data;
  const EditStokMaterialLogistikJktView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => EditStokMaterialLogistikJktController());
