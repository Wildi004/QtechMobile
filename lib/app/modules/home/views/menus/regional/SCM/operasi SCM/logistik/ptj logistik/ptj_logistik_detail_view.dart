...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/PTJ%20Logistik/ptj_logistik_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class PtjLogistikDetailView extends GetView<PtjLogistikDetailController> {
  final PtjLogistik? data;

  const PtjLogistikDetailView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => PtjLogistikDetailController()..data = data);
