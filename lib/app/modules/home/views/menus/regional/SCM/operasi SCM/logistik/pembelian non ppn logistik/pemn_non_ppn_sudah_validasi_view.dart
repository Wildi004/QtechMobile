...
class PemnNonPpnSudahValidasiView extends GetView<PembNonPpnController> {
  const PemnNonPpnSudahValidasiView({super.key});
              ...
              children: [
                ...data.generate((item, i) {
                  return CustomScalaContainer(
                    child: Touch(
                        onTap: () {
                          Get.to(() => PembNonPpnDetailView(data: item))
                              ?.then((value) {
