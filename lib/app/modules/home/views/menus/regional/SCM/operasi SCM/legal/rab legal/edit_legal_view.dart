...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Rab%20Legal/edit_legal_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditLegalView extends GetView<EditLegalController> {
  final RabLegal? data;

  const EditLegalView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.put(EditLegalController()..data = data);
