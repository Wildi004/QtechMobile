...
class PrintInvDelPoPpn extends GetxController {
  ...
  Future<void> cetakDelPoPpn(Map<String, dynamic> query) async {
    try {
      ...
      final uri = Uri.parse('${baseUrl}logistik/invoice/delivery/po-ppn/cetak')
      ...
      if (statusCode != 200) {
        ...
        Get.snackbar(
          'Gagal',
          'Tidak ada data Invoice yang ditemukan untuk filter ini.',
      ...
      final deliveryDir = Directory('${dir.path}/invoice/delivery/po-');
      ...
      if (Get.isDialogOpen ?? false) Get.back();
      debugPrint('[LOG] Terjadi error saat mencetak Invoice: $e');
      Get.snackbar(
        'Error',
        'Terjadi kesalahan saat mencetak Invoice.',
        backgroundColor: const Color.fromARGB(255, 171, 81, 74),
        colorText: Colors.white,
        snackPosition: SnackPosition.TOP,
        duration: const Duration(seconds: 3),
