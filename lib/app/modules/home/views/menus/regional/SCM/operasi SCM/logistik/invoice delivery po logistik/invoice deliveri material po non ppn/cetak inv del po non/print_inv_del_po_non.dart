...
class PrintInvDelPoNon extends GetxController {
  ...
  Future<void> cetakDelPoPpn(Map<String, dynamic> query) async {
    try {
      ...
      final uri =
          Uri.parse('${baseUrl}logistik/invoice/delivery/po-non-ppn/cetak')
      ...
      final deliveryDir = Directory('${dir.path}/invoice/delivery/po-non');
