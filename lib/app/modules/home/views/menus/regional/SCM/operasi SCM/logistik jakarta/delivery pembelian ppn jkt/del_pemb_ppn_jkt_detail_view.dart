...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Delivery%20Pembelian%20PPN%20Jkt/del_pemb_ppn_jkt_detail_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/custom_status_validasi.dart';

class DelPembPpnJktDetailView extends GetView<DelPembPpnJktDetailController> {
  final DelPembPpn? data;
  final bool showPrintButton;

  const DelPembPpnJktDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(DelPembPpnJktDetailController());
