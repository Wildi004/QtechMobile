...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Laporan%20Kerja%20Legal/create_laporan_kerja_legal_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateLaporanKerjaLegalView
    extends GetView<CreateLaporanKerjaLegalController> {
  const CreateLaporanKerjaLegalView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateLaporanKerjaLegalController());
