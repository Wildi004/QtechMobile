...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Pengajuan%20Logistik/create_pengajuan_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class CreatePengajuanLogistikView
    extends GetView<CreatePengajuanLogistikController> {
  const CreatePengajuanLogistikView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreatePengajuanLogistikController());
