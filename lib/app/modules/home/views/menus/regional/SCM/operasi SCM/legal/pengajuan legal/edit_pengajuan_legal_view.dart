...
import 'package:qrm_dev/app/modules/home/controllers/LEGAL/Pengajuan%20Legal/edit_pengajuan_legal_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditPengajuanLegalView extends GetView<EditPengajuanLegalController> {
  final PengajuanLegal? data;

  const EditPengajuanLegalView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditPengajuanLegalController());
