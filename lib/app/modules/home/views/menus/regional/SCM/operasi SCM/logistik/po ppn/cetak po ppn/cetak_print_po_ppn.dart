...
class CetakPrintPoPpn extends GetxController {
  final String baseUrl = AppConfig.baseUrl;

  Future<void> cetakPrintPoPpn(Map<String, dynamic> query) async {
    try {
      Get.dialog(
      ...
      debugPrint('[LOG] 🔹 Memanggil cetakPrintPoPpn dengan query: $query');

      final uri = Uri.parse('${baseUrl}logistik/po-ppn/cetak').replace(
        queryParameters:
