...
import 'package:qrm_dev/app/modules/home/controllers/LOGISTIK/Service%20Aset%20Logistik/create_service_aset_logistik_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateServiceAsetLogistikView
    extends GetView<CreateServiceAsetLogistikController> {
  final ServiceAset? data;
  const CreateServiceAsetLogistikView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateServiceAsetLogistikController());
