...
import 'package:qrm_dev/app/modules/home/controllers/Logistik%20Jakarta/Invoice%20Delivery%20Pembelian%20Jkt/Invoice%20Delivery%20Pembelian%20Non%20PPN/inv_del_pemb_jkt_non_ppn_detail_controller.dart';
...
class InvDelPembJktNonPpnDetailView
    extends GetView<InvDelPembJktNonPpnDetailController> {
  final InvDelPembNonPpn? data;
  final bool showPrintButton;

  const InvDelPembJktNonPpnDetailView({
    super.key,
    this.data,
  ...
  Widget build(BuildContext context) {
    Get.put(InvDelPembJktNonPpnDetailController());
