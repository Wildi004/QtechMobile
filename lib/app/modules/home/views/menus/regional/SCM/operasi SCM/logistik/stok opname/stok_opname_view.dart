...
import 'package:qrm_dev/app/modules/home/views/menus/regional/SCM/operasi%20SCM/logistik/stok%20opname/report_opname_view.dart';
...
class StokOpnameView extends GetView<StokOpnameController> {
  const StokOpnameView({super.key});
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  Get.to(
                                      () => ReportOpnameView(dataId: item.id));
                                },
                              ),
                              IconButton(
                                onPressed: () {
