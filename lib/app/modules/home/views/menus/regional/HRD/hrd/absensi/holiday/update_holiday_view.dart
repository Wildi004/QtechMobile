...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_absen_controller/holiday/update_holiday_controller.dart';

class UpdateHolidayView extends GetView<UpdateHolidayController> {
  final Holiday? data;

  const UpdateHolidayView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => UpdateHolidayController());
