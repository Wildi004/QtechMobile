...
import 'package:qrm_dev/app/modules/home/controllers/HRD/surat_menyurat_controller/surat%20menyurat%20hrd/surat_keluar_hrd_controller.dart';
...
class SuratKeluarHrdView extends GetView<SuratKeluarHrdController> {
  const SuratKeluarHrdView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => SuratKeluarHrdController());
