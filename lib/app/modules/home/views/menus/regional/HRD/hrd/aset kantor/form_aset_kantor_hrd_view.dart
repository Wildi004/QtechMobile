...
import 'package:qrm_dev/app/modules/home/controllers/HRD/aset_kantor_controller/edit_aset_kantor_hrd_controller.dart';
...
class FormAsetKantorHrdView extends GetView<EditAsetKantorHrdController> {
  final AsetKantorHrd? data;
  const FormAsetKantorHrdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    final imageC = Get.put(ImageFileTokenController());

    Get.lazyPut(() => EditAsetKantorHrdController());
