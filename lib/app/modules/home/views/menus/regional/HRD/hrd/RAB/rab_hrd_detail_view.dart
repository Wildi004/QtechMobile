...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_RAB_controller/rab_hrd_detail_controller.dart';
...
class RabHrdDetailView extends GetView<RabHrdDetailController> {
  final RabValidasi? data;

  const RabHrdDetailView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => RabHrdDetailController()..data = data);
