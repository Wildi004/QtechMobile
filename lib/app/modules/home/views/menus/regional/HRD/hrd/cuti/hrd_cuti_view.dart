...
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/cuti/belum_validasi_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/cuti/sudah_validasi_view.dart';
...
class HrdCutiView extends GetView<HrdCutiSudahValidasiController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppbar(title: 'Cuti').appBar,
      body: Column(
        children: [
          // Tab bar
          Padding(
