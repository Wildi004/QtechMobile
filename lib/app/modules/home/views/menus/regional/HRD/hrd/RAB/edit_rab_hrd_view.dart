...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_RAB_controller/edit_rab_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditRabHrdView extends GetView<EditRabController> {
  final RabValidasi? data;

  const EditRabHrdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.put(EditRabController()..data = data);
