...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_laporan_kerja_controller/create_laporan_kerja_hrd_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class CreateLaporanKerjaView extends GetView<CreateLaporanKerjaHrdController> {
  const CreateLaporanKerjaView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateLaporanKerjaHrdController());
