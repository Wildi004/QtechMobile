...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_arsip_controller/arsip_karyawan_barat_controller.dart';
...
class ArsipBaratView extends GetView<ArsipKaryawanBaratController> {
  const ArsipBaratView({super.key});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => ArsipKaryawanBaratController());

    final itemWidth = MediaQuery.of(context).size.width - 30;

    return Scaffold(
      appBar: CustomAppbar(title: 'Arsip Karyawan Barat').appBar,
      body: Obx(() {
