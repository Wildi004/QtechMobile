...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_RAB_controller/rab_hrd_controller.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/RAB/create_rab_hrd_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/RAB/rab_belum_validasi_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/RAB/rab_sudah_validasi_view.dart';
      ...
      appBar: CustomAppbar(
        ...
        actions: [
          Padding(
              ...
              child: IconButton(
                  onPressed: () {
                    Get.to(() => CreateRabHrdView())?.then((data) {
                      if (data != null) {
                        controller.insertData(RabValidasi.fromJson(data));
                      }
                    });
                  },
                  icon: Icon(
