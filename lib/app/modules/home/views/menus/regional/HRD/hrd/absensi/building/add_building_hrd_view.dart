...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_absen_controller/building/add_building_hrd_controller.dart';
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_absen_controller/building/map/map_create_view.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';

class AddBuildingHrdView extends GetView<AddBuildingHrdController> {
  final Building? data;
  const AddBuildingHrdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => AddBuildingHrdController());
