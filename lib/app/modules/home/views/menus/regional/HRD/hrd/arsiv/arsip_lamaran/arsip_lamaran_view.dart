...
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/arsiv/arsip_lamaran/create_arsip_lamaran_view.dart';
import 'package:qrm_dev/app/modules/home/views/menus/regional/HRD/hrd/arsiv/arsip_lamaran/detail_arsip_lamaran_view.dart';
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () {
                                    Get.to(() =>
                                            CreateArsipLamaranView(data: item))
                                        ?.then((value) {
                                      if (value != null) {
                                        controller.updateData(
                                            ArsipLamaran.fromJson(value),
                                            item.id!);
                                      }
                                    });
                                  },
