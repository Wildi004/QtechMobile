...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_absen_controller/shift/create_shift_hrd_controller.dart';

class AddShiftHrdView extends GetView<CreateShiftHrdController> {
  final Shifts? data;

  const AddShiftHrdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    Get.lazyPut(() => CreateShiftHrdController());
