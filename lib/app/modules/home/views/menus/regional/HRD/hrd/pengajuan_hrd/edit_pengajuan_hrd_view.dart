...
import 'package:qrm_dev/app/modules/home/controllers/HRD/hrd_pengajuan_controller/edit_pengajuan_controller.dart';
import 'package:qrm_dev/app/widgets/custom_appbar_widget.dart';
import 'package:qrm_dev/app/widgets/custom_loading.dart';
import 'package:qrm_dev/app/widgets/icon_action_widget.dart';

class EditPengajuanHrdView extends GetView<EditPengajuanController> {
  final PengajuanSudahValidasi? data;
  const EditPengajuanHrdView({super.key, this.data});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditPengajuanController());
