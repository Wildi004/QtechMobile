...
import 'package:qrm_dev/app/modules/home/controllers/HRD/karyawan_tidak_tetap_controller/detail_ktt_controller.dart';
...
class DetailKaryawanTidakView extends GetView<DetailKttController> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      top: false,
      child: Scaffold(
          appBar: CustomAppbar(title: 'Karyawan Tidak Tetap Detail').appBar,
          body: LzListView(
            gap: 10,
            children: [
              LzForm.input(
              ...
              LzForm.input(
                  label: 'NIK', enabled: false, model: forms.key('nik')),
              Row(
                children: [
                  Flexible(
                    child: LzForm.input(
