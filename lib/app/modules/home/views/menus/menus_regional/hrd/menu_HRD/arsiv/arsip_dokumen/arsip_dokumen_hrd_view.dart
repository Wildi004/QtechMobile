...
import 'package:qrm/app/modules/home/views/menus/menus_regional/hrd/menu_HRD/arsiv/arsip_dokumen/detail_arsip_dokumen_hrd_view.dart';
import 'package:qrm/app/modules/home/views/menus/menus_regional/hrd/menu_HRD/arsiv/arsip_dokumen/form_arsip_dokumen_view.dart';
                      ...
                      Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              Get.to(() => FormArsipDokumenView(data: item))
                                  ?.then((value) {
                                if (value != null) {
                                  controller.updateData(
                                      DokumenHrd.fromJson(value), item.id!);
