...
class CreateArsipKaryawanView extends GetView<CreateArsipKaryawanController> {
  ...
  const CreateArsipKaryawanView({super.key, this.data, this.userId});
          ...
          LzForm.input(
            ...
            onTap: () async {
              FilePickerResult? result = await FilePicker.platform.pickFiles(
                type: FileType
                    .any, // bisa juga FileType.custom dengan ekstensi tertentu
                allowMultiple: true,
              );
                ...
                children: controller.files.generate((file, i) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                        color: Colors.white, border: Br.only(['t'], except: i)),
                    child: Row(
                      children: [
