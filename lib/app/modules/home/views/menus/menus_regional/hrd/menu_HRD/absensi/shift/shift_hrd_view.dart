...
import 'package:qrm/app/modules/home/views/menus/menus_regional/hrd/menu_HRD/absensi/shift/detail_shift_hrd_view.dart';
import 'package:qrm/app/modules/home/views/menus/menus_regional/hrd/menu_HRD/absensi/shift/form_shift_hrd_view.dart';
        ...
        return LzListView(
          ...
          children: [
            ...
            ...data.generate((item, i) {
              return Touch(
                onTap: () {
                  Get.to(() => DetailShiftHrdView(data: item))?.then((value) {
                    if (value != null) {
                      controller.updateData(
                          Shifts.fromJson(value), item.shiftId!);
                    }
                  });
                },
                margin: Ei.only(b: 10),
