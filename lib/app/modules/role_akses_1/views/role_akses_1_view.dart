...
import 'package:qrm_dev/app/modules/role_akses_1/controllers/role_akses_1_controller.dart';
import 'package:qrm_dev/app/modules/role_akses_1/views/detail_role_akses_1_view.dart';
...
class RoleAkses1View extends GetView<RoleAkses1Controller> {
  const RoleAkses1View({super.key});
                              ...
                              child: Touch(
                                ...
                                onTap: () {
                                  action.show((value) async {
                                    if (value.index == 0) {
                                    Get.to(() => DetailRoleAkses1View(), arguments: item.id);
