...
class InvDelPembPpn {
  ...
  String? suplierName;
  List<DetailInvDelPembPpn>? detail;
  ...
  factory InvDelPembPpn.fromJson(Map<String, dynamic> json) => InvDelPembPpn(
        id: json['id'] as int?,
        ...
        detail: (json['detail'] as List<dynamic>?)
            ?.map(
                (e) => DetailInvDelPembPpn.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
  ...
  static List<InvDelPembPpn> fromJsonList(List? data) {
    return (data ?? []).map((e) => InvDelPembPpn.fromJson(e)).toList();
  }
}
