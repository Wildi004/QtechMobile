...
class DelPembNonPpn {
  ...
  factory DelPembNonPpn.fromJson(Map<String, dynamic> json) => DelPembNonPpn(
        id: json['id'] as int?,
        ...
        detail: (json['detail'] as List<dynamic>?)
            ?.map((e) => DetailDelPembNon.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
  ...
  static List<DelPembNonPpn> fromJsonList(List? data) {
    return (data ?? []).map((e) => DelPembNonPpn.fromJson(e)).toList();
  }
}
