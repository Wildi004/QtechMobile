...
class SuratJalanExst {
  ...
  factory SuratJalanExst.fromJson(Map<String, dynamic> json) {
    return SuratJalanExst(
      id: json['id'] as int?,
      ...
      detail: (json['detail'] as List<dynamic>?)
          ?.map((e) => DetailExst.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  static List<SuratJalanExst> fromJsonList(List? data) {
    return (data ?? []).map((e) => SuratJalanExst.fromJson(e)).toList();
  }
}
