...
class RabLogistik {
  ...
  String? approvalName;
  List<RabDetaillogistik>? rabDetail;
  ...
  factory RabLogistik.fromJson(Map<String, dynamic> json) => RabLogistik(
        id: json['id'] as int?,
        ...
        rabDetail: (json['rab_detail'] as List<dynamic>?)
            ?.map((e) => RabDetaillogistik.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
  ...
  static List<RabLogistik> fromJsonList(List? data) {
    return (data ?? []).map((e) => RabLogistik.fromJson(e)).toList();
  }
}
