class SaldoLogistik {
  ...
  factory SaldoLogistik.fromJson(Map<String, dynamic> json) => SaldoLogistik(
        id: json['id'] as int?,
  ...
  static List<SaldoLogistik> fromJsonList(List? data) {
    return (data ?? []).map((e) => SaldoLogistik.fromJson(e)).toList();
  }
}
