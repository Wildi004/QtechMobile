...
class DelPoPpn {
  ...
  factory DelPoPpn.fromJson(Map<String, dynamic> json) => DelPoPpn(
        id: json['id'] as int?,
        ...
        detail: (json['detail'] as List<dynamic>?)
            ?.map((e) => DetailDelpoPpn.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
  ...
  static List<DelPoPpn> fromJsonList(List? data) {
    return (data ?? []).map((e) => DelPoPpn.fromJson(e)).toList();
  }
}
