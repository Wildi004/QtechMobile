...
class RbpRb {
  ...
  factory RbpRb.fromJson(Map<String, dynamic> json) => RbpRb(
        id: json['id'] as int?,
        ...
        proyek: json['proyek'] == null
            ? null
            : ProyekRbp.fromJson(json['proyek'] as Map<String, dynamic>),
      );
  ...
  static List<RbpRb> fromJsonList(List? data) {
    return (data ?? []).map((e) => RbpRb.fromJson(e)).toList();
  }
}
