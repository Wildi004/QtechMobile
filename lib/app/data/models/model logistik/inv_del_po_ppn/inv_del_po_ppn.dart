...
class InvDelPoPpn {
  ...
  factory InvDelPoPpn.fromJson(Map<String, dynamic> json) => InvDelPoPpn(
        id: json['id'] as int?,
        ...
        detail: (json['detail'] as List<dynamic>?)
            ?.map((e) => DetailInvDelPoPpn.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
  ...
  static List<InvDelPoPpn> fromJsonList(List? data) {
    return (data ?? []).map((e) => InvDelPoPpn.fromJson(e)).toList();
  }
}
