class DetailPengajuanLogistik {
  ...
  factory DetailPengajuanLogistik.fromJson(Map<String, dynamic> json) =>
      DetailPengajuanLogistik(
        id: json['id'] as int?,
  ...
  static List<DetailPengajuanLogistik> fromJsonList(List? data) {
    return (data ?? [])
        .map((e) => DetailPengajuanLogistik.fromJson(e))
        .toList();
  }
}
