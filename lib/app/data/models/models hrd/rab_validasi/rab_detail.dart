class RabValidasiDetail {
  ...
  factory RabValidasiDetail.fromJson(Map<String, dynamic> json) =>
      RabValidasiDetail(
        id: json['id'] as int?,
  ...
  static List<RabValidasiDetail> fromJsonList(List? data) {
    return (data ?? []).map((e) => RabValidasiDetail.fromJson(e)).toList();
  }
}
