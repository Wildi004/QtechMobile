...
class PengajuanLegal {
  ...
  String? depName;
  List<DetailPengajuanLegal>? detail;
  ...
  factory PengajuanLegal.fromJson(Map<String, dynamic> json) {
    return PengajuanLegal(
      id: json['id'] as int?,
      ...
      detail: (json['detail'] as List<dynamic>?)
          ?.map((e) => DetailPengajuanLegal.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  static List<PengajuanLegal> fromJsonList(List? data) {
    return (data ?? []).map((e) => PengajuanLegal.fromJson(e)).toList();
  }
}
