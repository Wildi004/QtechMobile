class DetailPengajuanLegal {
  ...
  factory DetailPengajuanLegal.fromJson(Map<String, dynamic> json) =>
      DetailPengajuanLegal(
        id: json['id'] as int?,
  ...
  static List<DetailPengajuanLegal> fromJsonList(List? data) {
    return (data ?? []).map((e) => DetailPengajuanLegal.fromJson(e)).toList();
  }
}
