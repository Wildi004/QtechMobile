class RabDetailLegal {
  ...
  factory RabDetailLegal.fromJson(Map<String, dynamic> json) => RabDetailLegal(
        id: json['id'] as int?,
  ...
  static List<RabDetailLegal> fromJsonList(List? data) {
    return (data ?? []).map((e) => RabDetailLegal.fromJson(e)).toList();
  }
}
