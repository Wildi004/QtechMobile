class DetailValidasi {
  ...
  factory DetailValidasi.fromJson(Map<String, dynamic> json) => DetailValidasi(
        id: json['id'] as int?,
  ...
  static List<DetailValidasi> fromJsonList(List? data) {
    return (data ?? []).map((e) => DetailValidasi.fromJson(e)).toList();
  }
}
