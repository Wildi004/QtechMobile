...
class InvDelPoNonPpn {
  ...
  String? suplierName;
  List<DetailInvDelPoNonPpn>? detail;
  ...
  factory InvDelPoNonPpn.fromJson(Map<String, dynamic> json) {
    return InvDelPoNonPpn(
      id: json['id'] as int?,
      ...
      noHidePtj: json['no_hide_ptj'] as String?,
      ...
      detail: (json['detail'] as List<dynamic>?)
          ?.map((e) => DetailInvDelPoNonPpn.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  static List<InvDelPoNonPpn> fromJsonList(List? data) {
    return (data ?? []).map((e) => InvDelPoNonPpn.fromJson(e)).toList();
  }
}
