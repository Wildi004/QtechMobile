class AsetKantorLogJkt {
  ...
  factory AsetKantorLogJkt.fromJson(Map<String, dynamic> json) {
    return AsetKantorLogJkt(
      id: json['id'] as int?,
  ...
  static List<AsetKantorLogJkt> fromJsonList(List? data) {
    return (data ?? []).map((e) => AsetKantorLogJkt.fromJson(e)).toList();
  }
}
