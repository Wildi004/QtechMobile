...
class PengajuanDepBsd {
  ...
  String? depName;
  String? regionalName;
  List<DetailPengajuanBsd>? detail;
  ...
  factory PengajuanDepBsd.fromJson(Map<String, dynamic> json) {
    return PengajuanDepBsd(
      id: json['id'] as int?,
      ...
      detail: (json['detail'] as List<dynamic>?)
          ?.map((e) => DetailPengajuanBsd.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  static List<PengajuanDepBsd> fromJsonList(List? data) {
    return (data ?? []).map((e) => PengajuanDepBsd.fromJson(e)).toList();
  }
}
