class RabDepItDetail {
  ...
  factory RabDepItDetail.fromJson(Map<String, dynamic> json) {
    return RabDepItDetail(
      id: json['id'] as int?,
  ...
  static List<RabDepItDetail> fromJsonList(List? data) {
    return (data ?? []).map((e) => RabDepItDetail.fromJson(e)).toList();
  }
}
