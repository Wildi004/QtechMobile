class RabDetailIt {
  ...
  factory RabDetailIt.fromJson(Map<String, dynamic> json) => RabDetailIt(
        id: json['id'] as int?,
  ...
  static List<RabDetailIt> fromJsonList(List? data) {
    return (data ?? []).map((e) => RabDetailIt.fromJson(e)).toList();
  }
}
