...
class PengajuanIt {
  ...
  factory PengajuanIt.fromJson(Map<String, dynamic> json) => PengajuanIt(
        id: json['id'] as int?,
        ...
        detail: (json['detail'] as List<dynamic>?)
            ?.map((e) => DetailPengajuanIt.fromJson(e as Map<String, dynamic>))
            .toList(),
      );
  ...
  static List<PengajuanIt> fromJsonList(List? data) {
    return (data ?? []).map((e) => PengajuanIt.fromJson(e)).toList();
  }
}
